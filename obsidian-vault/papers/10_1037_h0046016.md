...
- [[discriminant-validity|Discriminant validity]] (0.64)
- [[discriminant|Discriminant]] (0.54)
- [[psychology|Psychology]] (0.49)
...
### Outgoing
- **cite** → [[10_1037_h0040957|Construct validity in psychological tests.]] — The multitrait-multimethod matrix paper extends Cronbach and Meehl's construct validity argument by proposing convergent and discriminant validity as empirical tests.
- **enables** → [[10_2307_249008|Perceived Usefulness, Perceived Ease of Use, and User Acceptance of Information Technology]] — The multitrait-multimethod validation framework provided the construct-validity logic Davis used to validate perceived usefulness and perceived ease of use.
- **enables** → [[10_1037_h0092976|Generalized expectancies for internal versus external control of reinforcement.]] — The multitrait-multimethod framework for construct validation supported Rotter's validation of internal versus external locus-of-control expectancies as a psychological construct.
- **enables** → [[10_1037__0022_3514_51_6_1173|The moderator-mediator variable distinction in social psychological research: Conceptual, strategic, and statistical considerations.]] — The multitrait-multimethod framework established discriminant validity logic that Baron and Kenny applied to distinguish moderator and mediator variables.
- **enables** → [[10_2307_2666999|Psychological Safety and Learning Behavior in Work Teams]] — The multitrait-multimethod matrix enabled Edmondson to support psychological safety as a construct distinct from related team-climate measures.

### Incoming
- **cite** ← [[10_2307_249008|Perceived Usefulness, Perceived Ease of Use, and User Acceptance of Information Technology]] — The technology-acceptance model uses the multitrait-multimethod matrix as the validation framework for convergent and discriminant construct validity.
- **cite** ← [[10_1037_h0092976|Generalized expectancies for internal versus external control of reinforcement.]] — Rotter's locus-of-control scale cites the multitrait-multimethod matrix as a validation framework for distinguishing convergent from discriminant evidence.
- **cite** ← [[10_1037__0022_3514_51_6_1173|The moderator-mediator variable distinction in social psychological research: Conceptual, strategic, and statistical considerations.]] — Baron and Kenny cite the multitrait-multimethod matrix as a validity framework for distinguishing mediation and moderation constructs.
- **cite** ← [[10_2307_2666999|Psychological Safety and Learning Behavior in Work Teams]] — Edmondson uses multitrait-multimethod validation logic to establish psychological safety as empirically distinct from related team constructs.

## Sources

- DOI: <https://doi.org/10.1037/h0046016>
- OpenAlex: <https://openalex.org/W2024509488>