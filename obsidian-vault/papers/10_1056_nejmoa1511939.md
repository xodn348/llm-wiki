...
- [[blood-pressure|Blood pressure]] (0.80)
- [[medicine|Medicine]] (0.72)
- [[randomized-controlled-trial|Randomized controlled trial]] (0.63)
- [[diabetes-mellitus|Diabetes mellitus]] (0.56)
- [[cardiology|Cardiology]] (0.48)
...
### Outgoing
- **cite** → [[10_1080_01621459_1999_10474144|A Proportional Hazards Model for the Subdistribution of a Competing Risk]] — The SPRINT trial uses Fine and Gray's subdistribution proportional hazards model to analyze outcomes such as cardiovascular events in the presence of competing risks like noncardiovascular death.

### Incoming
- **enables** ← [[10_1080_01621459_1999_10474144|A Proportional Hazards Model for the Subdistribution of a Competing Risk]] — The Fine-Gray subdistribution hazards model links them through competing-risk analysis of cardiovascular outcomes in the SPRINT trial.

## Sources

- DOI: <https://doi.org/10.1056/nejmoa1511939>
- OpenAlex: <https://openalex.org/W3150595609>