...
- [[neutron-star|Neutron star]] (0.93)
- [[gravitational-wave|Gravitational wave]] (0.85)
- [[physics|Physics]] (0.79)
- [[binary-number|Binary number]] (0.69)
- [[astrophysics|Astrophysics]] (0.53)
...
### Outgoing
- **cite** → [[10_1103_physrevlett_116_061102|Observation of Gravitational Waves from a Binary Black Hole Merger]] — GW170817 cites GW150914 as the first demonstrated LIGO gravitational-wave detection method, now applied to a binary neutron-star inspiral.

### Incoming
- **cite** ← [[10_1051_0004_6361_201833910|<i>Planck</i> 2018 results]] — Planck 2018 cites GW170817 as an external multi-messenger constraint relevant to cosmological parameters such as the Hubble constant and relativistic physics.

## Sources

- DOI: <https://doi.org/10.1103/physrevlett.119.161101>
- OpenAlex: <https://openalex.org/W2765081049>