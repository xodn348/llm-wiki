...
- [[compressed-sensing|Compressed sensing]] (0.62)
- [[orthonormal-basis|Orthonormal basis]] (0.59)
- [[artificial-intelligence|Artificial intelligence]] (0.43)
- [[pixel|Pixel]] (0.42)
...
### Outgoing
- **cite** → [[10_1109_tit_2005_862083|Robust uncertainty principles: exact signal reconstruction from highly incomplete frequency information]] — Candes and Tao's compressed sensing paper builds directly on their robust uncertainty principle showing exact recovery from incomplete Fourier samples.

### Incoming
- **cite** ← [[10_1137_080738970|A Singular Value Thresholding Algorithm for Matrix Completion]] — Singular value thresholding adapts the compressed-sensing idea of sparse recovery from few samples to low-rank matrix completion.

## Sources

- DOI: <https://doi.org/10.1109/tit.2006.871582>
- OpenAlex: <https://openalex.org/W4250955649>