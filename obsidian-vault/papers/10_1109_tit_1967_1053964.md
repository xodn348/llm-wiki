...
- [[bayes-theorem|Bayes' theorem]] (0.66)
- [[k-nearest-neighbors-algorithm|k-nearest neighbors algorithm]] (0.60)
- [[probability-distribution|Probability distribution]] (0.51)
- [[artificial-intelligence|Artificial intelligence]] (0.51)
- [[mathematics|Mathematics]] (0.46)
...
### Outgoing
- **cite** → [[10_1037_0033_295x_101_2_343|The magical number seven, plus or minus two: Some limits on our capacity for processing information.]] — The nearest-neighbor classification paper cites Miller's capacity-limit work as background on pattern recognition and information processing limits.

## Sources

- DOI: <https://doi.org/10.1109/tit.1967.1053964>
- OpenAlex: <https://openalex.org/W2122111042>