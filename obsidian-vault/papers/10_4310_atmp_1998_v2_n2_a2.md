...
- [[de-sitter-space|De Sitter space]] (0.67)
- [[anti-de-sitter-space|Anti-de Sitter space]] (0.62)
- [[space-punctuation|Space (punctuation)]] (0.50)
- [[de-sitterschwarzschild-metric|de Sitter–Schwarzschild metric]] (0.50)
- [[physics|Physics]] (0.48)
...
### Outgoing
- **cite** → [[10_4310_atmp_1998_v2_n2_a1|The large $N$ limit of superconformal field theories and supergravity]] — Witten develops the AdS/CFT holographic dictionary proposed by Maldacena between large-N conformal field theories and supergravity on anti-de Sitter space.

## Sources

- DOI: <https://doi.org/10.4310/atmp.1998.v2.n2.a2>
- OpenAlex: <https://openalex.org/W1889142700>