...
- **cite** → [Equation of State Calculations by Fast Computing Machines](10_1063_1_1699114.md) — Simulated annealing imports the Metropolis Monte Carlo acceptance rule from statistical mechanics into combinatorial optimization.
- **enables** ← [Equation of State Calculations by Fast Computing Machines](10_1063_1_1699114.md) — Simulated annealing adapts the Metropolis Monte Carlo acceptance rule from statistical physics simulations to probabilistic optimization.
## Sources
