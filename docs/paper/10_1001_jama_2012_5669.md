...
- **cite** → [Comparing the Areas under Two or More Correlated Receiver Operating Characteristic Curves: A Nonparametric Approach](10_2307_2531595.md) — The ARDS study uses DeLong's nonparametric method to compare correlated ROC areas for diagnostic or prognostic performance.
- **enables** ← [Comparing the Areas under Two or More Correlated Receiver Operating Characteristic Curves: A Nonparametric Approach](10_2307_2531595.md) — DeLong's nonparametric correlated-ROC comparison method underlies diagnostic accuracy evaluation for clinical predictors used in acute respiratory distress syndrome research.
