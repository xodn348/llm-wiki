...
- **cite** → [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Particle swarm optimization cites Fisher's discriminant analysis as a benchmark-style statistical classification method used in evaluating optimization and pattern recognition.
- **enables** → [Particle swarm optimization](10_1007_s11721_007_0002_0.md) — The 2002 particle swarm optimization work supplied core algorithmic variants that the 2007 treatment consolidated and analyzed.
- **cite** ← [A new optimizer using particle swarm theory](10_1109_mhs_1995_494215.md) — The paper extends the original particle swarm optimization method based on population particles moving by personal and social best positions.
- **cite** ← [Particle swarm optimization](10_1007_s11721_007_0002_0.md) — The 2007 paper summarizes earlier particle swarm optimization variants and parameter analyses from the 2002 PSO literature.
- **enables** ← [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Fisher's discriminant analysis introduced multivariate classification ideas that later served as benchmark-style optimization problems for particle swarm methods.
