...
- **enables** → [Gapped BLAST and PSI-BLAST: a new generation of protein database search programs](10_1093_nar_25_17_3389.md) — RANSAC's robust consensus-from-candidates idea parallels BLAST's use of seed hits to identify reliable alignments amid noisy matches.
- **enables** → [Robust principal component analysis?](10_1145_1970392_1970395.md) — RANSAC established robustness by fitting a model despite outliers, a goal robust PCA convexifies for low-rank matrix recovery with sparse errors.
- **cite** ← [Gapped BLAST and PSI-BLAST: a new generation of protein database search programs](10_1093_nar_25_17_3389.md) — PSI-BLAST uses iterative profile refinement, conceptually related to RANSAC's repeated sampling to improve a model from noisy matches.
- **cite** ← [Robust principal component analysis?](10_1145_1970392_1970395.md) — Robust PCA cites RANSAC as an earlier robust-estimation method for handling outliers, but replaces sampling consensus with convex low-rank and sparse recovery.
