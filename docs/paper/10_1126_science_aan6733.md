...
- **cite** → [PD-1 Blockade in Tumors with Mismatch-Repair Deficiency](10_1056_nejmoa1500596.md) — The 2017 study generalizes the 2015 finding that mismatch-repair deficiency predicts clinical response to PD-1 blockade.
- **cite** → [PD-1 blockade induces responses by inhibiting adaptive immune resistance](10_1038_nature13954.md) — The mismatch-repair study relies on adaptive immune resistance as the mechanism by which PD-1 blockade restores antitumor T-cell activity.
- **cite** → [Mutational landscape determines sensitivity to PD-1 blockade in non–small cell lung cancer](10_1126_science_aaa1348.md) — The paper links mismatch-repair deficiency to PD-1 sensitivity through the same high-mutational-burden neoantigen mechanism shown in lung cancer.
- **cite** → [A general method applicable to the search for similarities in the amino acid sequence of two proteins](10_1016_0022_2836_70_90057_4.md) — The study uses sequence-similarity methods rooted in Needleman-Wunsch-style alignment to analyze tumor mutations and predicted neoantigens.
- **enables** ← [A general method applicable to the search for similarities in the amino acid sequence of two proteins](10_1016_0022_2836_70_90057_4.md) — Needleman-Wunsch sequence alignment enabled later detection of mutation-derived neoantigens whose mismatch-repair-deficient tumors respond to PD-1 blockade.
