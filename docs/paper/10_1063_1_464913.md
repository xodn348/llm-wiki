...
- **cite** → [A new mixing of Hartree–Fock and local density-functional theories](10_1063_1_464304.md) — Becke's thermochemistry functional incorporates the hybrid Hartree-Fock and density-functional mixing strategy introduced in the 1993 mixing paper.
- **cite** → [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — B3LYP uses Becke's 1988 gradient-corrected exchange functional as a component of its exchange-energy approximation.
- **cite** → [Atoms, molecules, solids, and surfaces: Applications of the generalized gradient approximation for exchange and correlation](10_1103_physrevb_46_6671.md) — Becke's hybrid functional is compared against generalized-gradient exchange-correlation approximations developed for atoms, molecules, solids, and surfaces.
- **enables** → [Hybrid functionals based on a screened Coulomb potential](10_1063_1_1564060.md) — Becke's exact-exchange thermochemistry work established hybrid density functionals, the core idea later adapted in HSE with screened Coulomb exchange.
- **cite** ← [Hybrid functionals based on a screened Coulomb potential](10_1063_1_1564060.md) — HSE adapts the hybrid-functional idea of mixing exact Hartree-Fock exchange from B3LYP-style thermochemistry to a screened Coulomb form for solids.
- **enables** ← [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — Becke's gradient-corrected exchange functional enabled B3LYP's hybrid exact-exchange density-functional thermochemistry model.
