...
- **cite** → [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — B3LYP links to Becke 1988 by using Becke's gradient-corrected exchange as a component in a hybrid exact-exchange functional.
- **enables** ← [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — B3LYP incorporates Becke's 1988 gradient-corrected exchange as part of a hybrid functional with exact exchange.
## Sources
