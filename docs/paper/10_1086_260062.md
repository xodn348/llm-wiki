...
- **cite** → [CAPITAL ASSET PRICES: A THEORY OF MARKET EQUILIBRIUM UNDER CONDITIONS OF RISK*](10_1111_j_1540_6261_1964_tb02865_x.md) — Black and Scholes connect option pricing to CAPM-style equilibrium reasoning about risk and expected return.
- **cite** ← [ON THE PRICING OF CORPORATE DEBT: THE RISK STRUCTURE OF INTEREST RATES*](10_1111_j_1540_6261_1974_tb03058_x.md) — Merton extends Black and Scholes' option-pricing framework by modeling corporate debt as a contingent claim on firm value.
- **cite** ← [Theory of the firm: Managerial behavior, agency costs and ownership structure](10_1016_0304_405x_76_90026_x.md) — Jensen and Meckling draw on Black and Scholes's option-pricing framework to treat equity and debt as contingent claims on the firm's assets.
- **enables** ← [CAPITAL ASSET PRICES: A THEORY OF MARKET EQUILIBRIUM UNDER CONDITIONS OF RISK*](10_1111_j_1540_6261_1964_tb02865_x.md) — CAPM's risk-neutral equilibrium framing helped make no-arbitrage pricing of risky securities, including Black-Scholes option pricing, mathematically natural.
