...
- **cite** → [Theory of the firm: Managerial behavior, agency costs and ownership structure](10_1016_0304_405x_76_90026_x.md) — Corporate Ownership Around the World uses Jensen and Meckling’s agency-cost theory to analyze conflicts between controlling owners, managers, and minority shareholders.
- **cite** → [Law and Finance](10_1086_250042.md) — Corporate Ownership Around the World builds on Law and Finance’s claim that legal investor protections shape ownership concentration and corporate control.
- **enables** ← [Theory of the firm: Managerial behavior, agency costs and ownership structure](10_1016_0304_405x_76_90026_x.md) — Agency-cost theory supplied the ownership-control framework that La Porta and colleagues used to compare corporate ownership structures across countries.
