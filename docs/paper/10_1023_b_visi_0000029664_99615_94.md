...
- **enables** → [ImageNet: A large-scale hierarchical image database](10_1109_cvpr_2009_5206848.md) — ImageNet's visual recognition benchmark was built in a field where SIFT-style local image descriptors were a dominant feature representation.
- **enables** → [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — SIFT established robust local image descriptors that shaped the feature-engineering baselines used in early ImageNet challenge recognition systems.
- **cite** ← [ImageNet: A large-scale hierarchical image database](10_1109_cvpr_2009_5206848.md) — ImageNet links to SIFT by using local invariant image descriptors as part of the pre-deep-learning visual recognition context.
- **cite** ← [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — ILSVRC cites SIFT as a representative pre-deep-learning local image descriptor used in earlier visual recognition systems.
## Sources
