...
- **cite** → [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — PBE links to Becke 1988 by building a generalized gradient approximation for exchange-correlation that follows earlier gradient-corrected exchange functionals.
- **cite** → [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — PBE links to Kohn-Sham by formulating its exchange-correlation functional within the self-consistent density-functional equations.
- **enables** ← [Density-functional exchange-energy approximation with correct asymptotic behavior](10_1103_physreva_38_3098.md) — PBE builds on Becke's gradient-corrected exchange by constructing a generalized gradient approximation for exchange-correlation energy.
- **enables** ← [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — PBE extends the Kohn-Sham density-functional framework by providing a practical generalized gradient exchange-correlation functional.
## Sources
