...
- **cite** → [An Evolutionary Theory of Economic Change.](10_2307_2232409.md) — Absorptive capacity builds on evolutionary economics by treating firm learning and innovation as path-dependent capabilities shaped by prior knowledge.
- **enables** → [Toward a knowledge‐based theory of the firm](10_1002_smj_4250171110.md) — Absorptive capacity defined firms' ability to acquire and use external knowledge, a core mechanism in the knowledge-based theory of the firm.
- **cite** ← [Toward a knowledge‐based theory of the firm](10_1002_smj_4250171110.md) — Grant uses absorptive capacity to connect firm knowledge integration with the ability to recognize and apply external knowledge.
- **enables** ← [An Evolutionary Theory of Economic Change.](10_2307_2232409.md) — Nelson and Winter's evolutionary view of firm routines and learning underpinned Cohen and Levinthal's claim that prior knowledge determines absorptive capacity.
