...
- **enables** → [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Kaplan-Meier product-limit survival estimation for censored observations provided the survival-analysis foundation that Cox extended with proportional hazards regression.
- **enables** → [Human Breast Cancer: Correlation of Relapse and Survival with Amplification of the HER-2/<i>neu</i>Oncogene](10_1126_science_3798106.md) — Kaplan-Meier estimation enabled Slamon et al. to compare censored relapse-free and overall survival curves by HER-2/neu amplification status.
- **cite** ← [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox's life-table regression builds on Kaplan-Meier nonparametric survival estimation for incomplete censored observations.
- **cite** ← [Human Breast Cancer: Correlation of Relapse and Survival with Amplification of the HER-2/<i>neu</i>Oncogene](10_1126_science_3798106.md) — The HER-2/neu breast-cancer study uses Kaplan-Meier survival estimation to analyze censored relapse and survival data.
