...
- **enables** → [Human Breast Cancer: Correlation of Relapse and Survival with Amplification of the HER-2/<i>neu</i>Oncogene](10_1126_science_3798106.md) — Kaplan-Meier nonparametric survival estimation enabled the relapse-free and overall survival curve comparisons used in the HER-2/neu breast cancer study.
- **enables** → [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Kaplan-Meier nonparametric survival estimation supplied the censored-time framework that Cox regression extends with covariates.
- **cite** ← [Human Breast Cancer: Correlation of Relapse and Survival with Amplification of the HER-2/<i>neu</i>Oncogene](10_1126_science_3798106.md) — The HER-2/neu breast cancer paper uses Kaplan-Meier survival estimation to analyze relapse-free and overall survival with censored patient observations.
- **cite** ← [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox's life-table regression builds on Kaplan and Meier's nonparametric treatment of censored survival times.
