...
- **enables** → [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox regression builds on Kaplan-Meier survival analysis by modeling covariate effects while handling right-censored life-table data.
- **cite** ← [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox's proportional hazards model builds on Kaplan-Meier nonparametric survival estimation for censored life-table data.
## Sources
