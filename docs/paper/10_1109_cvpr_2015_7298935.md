...
- **cite** → [Long Short-Term Memory](10_1162_neco_1997_9_8_1735.md) — Show and Tell uses an LSTM decoder to generate image-caption word sequences from convolutional image features.
- **cite** → [BLEU](10_3115_1073083_1073135.md) — Show and Tell evaluates generated captions with BLEU, the n-gram precision metric originally developed for machine translation.
- **cite** → [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — Show and Tell uses ImageNet-pretrained convolutional networks as the visual encoder for caption generation.
- **cite** ← [Grad-CAM: Visual Explanations from Deep Networks via Gradient-Based Localization](10_1109_iccv_2017_74.md) — Grad-CAM evaluates visual explanations on image-captioning networks exemplified by the Show and Tell neural caption generator.
- **enables** ← [Long Short-Term Memory](10_1162_neco_1997_9_8_1735.md) — LSTM provided the recurrent sequence model used by Show and Tell to generate image captions word by word from CNN image features.
- **enables** ← [BLEU](10_3115_1073083_1073135.md) — BLEU supplied the automatic n-gram evaluation metric used to score generated captions in Show and Tell.
