...
- **cite** ← [SARS-CoV-2 Cell Entry Depends on ACE2 and TMPRSS2 and Is Blocked by a Clinically Proven Protease Inhibitor](10_1016_j_cell_2020_02_052.md) — The SARS-CoV-2 entry study relies on RT-PCR detection methods to identify and validate infection with the novel coronavirus.
