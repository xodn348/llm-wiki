...
- **enables** → [Distinctive Image Features from Scale-Invariant Keypoints](10_1023_b_visi_0000029664_99615_94.md) — The Harris corner detector introduced repeatable local interest-point detection, a precursor to SIFT's scale-space keypoint localization.
- **cite** ← [Distinctive Image Features from Scale-Invariant Keypoints](10_1023_b_visi_0000029664_99615_94.md) — Lowe's SIFT contrasts scale-invariant keypoints with Harris and Stephens' corner detector as an earlier local feature detector lacking full scale invariance.
