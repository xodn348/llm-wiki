...
- **cite** → [An integrated map of genetic variation from 1,092 human genomes](10_1038_nature11632.md) — The cancer mutational-signature study uses population variant data from the 1000 Genomes Project to help distinguish somatic mutations from germline variation.
- **cite** → [Comprehensive molecular characterization of human colon and rectal cancer](10_1038_nature11252.md) — The mutational-signature analysis incorporates colorectal cancer genome data from TCGA to identify cancer-type-specific mutation patterns.
- **cite** ← [Mutational landscape determines sensitivity to PD-1 blockade in non–small cell lung cancer](10_1126_science_aaa1348.md) — Rizvi et al. use Alexandrov et al.'s mutational-signature framework to identify smoking-associated mutation patterns in lung cancer tumors.
- **cite** ← [Pembrolizumab for the Treatment of Non–Small-Cell Lung Cancer](10_1056_nejmoa1501824.md) — The pembrolizumab study uses cancer mutational signatures, especially smoking-associated mutation patterns, to interpret why some NSCLC tumors respond to PD-1 blockade.
