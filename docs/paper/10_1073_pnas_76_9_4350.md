...
- **cite** → [Detection of specific sequences among DNA fragments separated by gel electrophoresis](10_1016_s0022_2836_75_80083_0.md) — The protein blotting procedure adapts Southern's gel-transfer and membrane-hybridization concept from DNA fragments to proteins.
- **cite** → [Cleavage of Structural Proteins during the Assembly of the Head of Bacteriophage T4](10_1038_227680a0.md) — The paper uses SDS-polyacrylamide gel electrophoresis methods associated with Laemmli's bacteriophage T4 protein-separation work.
- **enables** ← [Cleavage of Structural Proteins during the Assembly of the Head of Bacteriophage T4](10_1038_227680a0.md) — Laemmli's SDS-PAGE separation of bacteriophage T4 proteins enabled Towbin's Western blot by providing the gel-resolved proteins that could be transferred to nitrocellulose.
