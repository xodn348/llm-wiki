...
- **cite** → [Detection of specific sequences among DNA fragments separated by gel electrophoresis](10_1016_s0022_2836_75_80083_0.md) — Towbin et al. adapted Southern's gel-to-membrane transfer principle from DNA fragments to proteins, creating the protein blotting method later called Western blotting.
- **cite** → [Cleavage of Structural Proteins during the Assembly of the Head of Bacteriophage T4](10_1038_227680a0.md) — Towbin et al. used Laemmli's SDS-polyacrylamide gel electrophoresis system for separating proteins before electrophoretic transfer to nitrocellulose.
- **enables** ← [Cleavage of Structural Proteins during the Assembly of the Head of Bacteriophage T4](10_1038_227680a0.md) — Western blotting depends on SDS-PAGE protein separation introduced in the Laemmli bacteriophage T4 assembly study.
## Sources
