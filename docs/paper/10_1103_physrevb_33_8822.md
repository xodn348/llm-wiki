...
- **cite** → [Ground State of the Electron Gas by a Stochastic Method](10_1103_physrevlett_45_566.md) — Perdew and Wang used Ceperley and Alder's quantum Monte Carlo electron-gas energies to parameterize correlation energy.
- **cite** → [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — The 1986 correlation functional supplies the exchange-correlation term required by the Kohn-Sham self-consistent equations.
- **enables** → [Atoms, molecules, solids, and surfaces: Applications of the generalized gradient approximation for exchange and correlation](10_1103_physrevb_46_6671.md) — Perdew's 1986 correlation functional supplied a gradient-corrected correlation term that fed directly into the 1992 generalized gradient approximation for exchange and correlation.
- **cite** ← [Development of the Colle-Salvetti correlation-energy formula into a functional of the electron density](10_1103_physrevb_37_785.md) — Lee, Yang, and Parr adapt Perdew and Wang's inhomogeneous-electron-gas correlation approximation into the LYP electron-density functional.
- **cite** ← [Atoms, molecules, solids, and surfaces: Applications of the generalized gradient approximation for exchange and correlation](10_1103_physrevb_46_6671.md) — The 1992 GGA paper uses the 1986 Perdew correlation functional as its correlation-energy component.
- **enables** ← [Ground State of the Electron Gas by a Stochastic Method](10_1103_physrevlett_45_566.md) — Quantum Monte Carlo results for the electron gas supplied benchmark correlation energies used to parameterize the 1986 density-functional approximation.
- **enables** ← [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — Kohn-Sham self-consistent density-functional equations created the exchange-correlation framework that the 1986 inhomogeneous electron-gas approximation improved.
