...
- **cite** → [THE GENETICS OF <i>CAENORHABDITIS ELEGANS</i>](10_1093_genetics_77_1_71.md) — The lin-4 study builds on Brenner's C. elegans genetic system to analyze heterochronic developmental genes.
- **cite** → [DNA sequencing with chain-terminating inhibitors](10_1073_pnas_74_12_5463.md) — The lin-4 study uses Sanger chain-termination sequencing to identify the small RNAs encoded by the lin-4 locus.
- **enables** ← [THE GENETICS OF <i>CAENORHABDITIS ELEGANS</i>](10_1093_genetics_77_1_71.md) — Brenner's genetic framework for C. elegans enabled lin-4 to be identified as a developmental timing gene in the heterochronic pathway.
- **enables** ← [DNA sequencing with chain-terminating inhibitors](10_1073_pnas_74_12_5463.md) — Sanger chain-termination sequencing enabled the nucleotide-level discovery that lin-4 produces small RNAs complementary to lin-14.
