...
- **cite** → [Learning representations by back-propagating errors](10_1038_323533a0.md) — TensorFlow operationalizes back-propagation as a scalable automatic-differentiation framework for training neural networks.
- **cite** → [Long Short-Term Memory](10_1162_neco_1997_9_8_1735.md) — TensorFlow supports recurrent architectures such as LSTMs for sequence modeling at scale.
- **cite** → [Going deeper with convolutions](10_1109_cvpr_2015_7298594.md) — TensorFlow cites Inception to illustrate large convolutional neural networks enabled by modern deep-learning systems.
- **cite** → [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — TensorFlow uses ImageNet-scale vision benchmarks as a motivating workload for distributed deep-learning infrastructure.
- **cite** → [Human-level control through deep reinforcement learning](10_1038_nature14236.md) — TensorFlow cites DQN as an example of deep reinforcement learning workloads that require flexible neural-network computation.
- **cite** → [Deep Neural Networks for Acoustic Modeling in Speech Recognition: The Shared Views of Four Research Groups](10_1109_msp_2012_2205597.md) — TensorFlow cites deep acoustic modeling to show neural networks' impact on speech recognition applications.
- **cite** → [Deep Residual Learning for Image Recognition](10_1109_cvpr_2016_90.md) — TensorFlow cites residual networks as a state-of-the-art deep architecture requiring efficient large-scale training support.
- **enables** ← [Learning representations by back-propagating errors](10_1038_323533a0.md) — Back-propagation is the core automatic-differentiation training method that TensorFlow operationalized at large scale.
- **enables** ← [Long Short-Term Memory](10_1162_neco_1997_9_8_1735.md) — LSTM introduced gated recurrent memory cells that TensorFlow later made practical to implement and scale as neural-network sequence models.
