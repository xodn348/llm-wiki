...
- **cite** ← [Electron-Hole Diffusion Lengths Exceeding 1 Micrometer in an Organometal Trihalide Perovskite Absorber](10_1126_science_1243982.md) — The diffusion-length paper follows the 2009 demonstration that organometal halide perovskites can act as visible-light photovoltaic sensitizers.
- **cite** ← [Sequential deposition as a route to high-performance perovskite-sensitized solar cells](10_1038_nature12340.md) — Sequential deposition extends the use of organometal halide perovskites as visible-light photovoltaic sensitizers first demonstrated in liquid-electrolyte cells.
- **cite** ← [Efficient Hybrid Solar Cells Based on Meso-Superstructured Organometal Halide Perovskites](10_1126_science_1228604.md) — Lee et al. extend the 2009 perovskite-sensitized photovoltaic concept by using a meso-superstructured scaffold for higher-efficiency solid-state cells.
- **cite** ← [Lead Iodide Perovskite Sensitized All-Solid-State Submicron Thin Film Mesoscopic Solar Cell with Efficiency Exceeding 9%](10_1038_srep00591.md) — The 2012 solid-state perovskite cell builds on the 2009 finding that organometal halide perovskites can act as visible-light photovoltaic sensitizers.
