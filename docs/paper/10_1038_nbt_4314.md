...
- **cite** → [A Global Geometric Framework for Nonlinear Dimensionality Reduction](10_1126_science_290_5500_2319.md) — UMAP shares Isomap's goal of preserving nonlinear manifold geometry for low-dimensional visualization.
- **enables** ← [A Global Geometric Framework for Nonlinear Dimensionality Reduction](10_1126_science_290_5500_2319.md) — Isomap's manifold-learning framing helped motivate UMAP's nonlinear dimensionality reduction for preserving single-cell data structure.
