...
- **cite** → [The social readjustment rating scale](10_1016_0022_3999_67_90010_4.md) — The buffering-hypothesis paper relates social support to stress effects measured against life-event stress scales such as the Social Readjustment Rating Scale.
- **enables** → [The need to belong: Desire for interpersonal attachments as a fundamental human motivation.](10_1037_0033_2909_117_3_497.md) — The buffering hypothesis linked social support to stress protection, feeding the claim that interpersonal attachment is a basic human need.
- **cite** ← [The need to belong: Desire for interpersonal attachments as a fundamental human motivation.](10_1037_0033_2909_117_3_497.md) — The need-to-belong theory cites the buffering hypothesis as evidence that social support protects people from stress.
- **enables** ← [The social readjustment rating scale](10_1016_0022_3999_67_90010_4.md) — The social readjustment scale operationalized stressful life events, enabling tests of whether social support buffers stress-health relationships.
