...
- **cite** → [Construct validity in psychological tests.](10_1037_h0040957.md) — The multitrait-multimethod matrix paper extends Cronbach and Meehl's construct validity argument by proposing convergent and discriminant validity as empirical tests.
- **enables** → [Perceived Usefulness, Perceived Ease of Use, and User Acceptance of Information Technology](10_2307_249008.md) — The multitrait-multimethod validation framework provided the construct-validity logic Davis used to validate perceived usefulness and perceived ease of use.
- **enables** → [Generalized expectancies for internal versus external control of reinforcement.](10_1037_h0092976.md) — The multitrait-multimethod framework for construct validation supported Rotter's validation of internal versus external locus-of-control expectancies as a psychological construct.
- **enables** → [The moderator-mediator variable distinction in social psychological research: Conceptual, strategic, and statistical considerations.](10_1037__0022_3514_51_6_1173.md) — The multitrait-multimethod framework established discriminant validity logic that Baron and Kenny applied to distinguish moderator and mediator variables.
- **enables** → [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — The multitrait-multimethod matrix enabled Edmondson to support psychological safety as a construct distinct from related team-climate measures.
- **cite** ← [Perceived Usefulness, Perceived Ease of Use, and User Acceptance of Information Technology](10_2307_249008.md) — The technology-acceptance model uses the multitrait-multimethod matrix as the validation framework for convergent and discriminant construct validity.
- **cite** ← [Generalized expectancies for internal versus external control of reinforcement.](10_1037_h0092976.md) — Rotter's locus-of-control scale cites the multitrait-multimethod matrix as a validation framework for distinguishing convergent from discriminant evidence.
- **cite** ← [The moderator-mediator variable distinction in social psychological research: Conceptual, strategic, and statistical considerations.](10_1037__0022_3514_51_6_1173.md) — Baron and Kenny cite the multitrait-multimethod matrix as a validity framework for distinguishing mediation and moderation constructs.
- **cite** ← [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — Edmondson uses multitrait-multimethod validation logic to establish psychological safety as empirically distinct from related team constructs.
