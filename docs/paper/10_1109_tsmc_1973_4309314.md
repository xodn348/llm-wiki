...
- **enables** → [Radiomics: Images Are More than Pictures, They Are Data](10_1148_radiol_2015151169.md) — Haralick's texture features showed that quantitative image patterns can be extracted as data, enabling radiomics to treat medical images as mineable feature sets.
- **cite** ← [Radiomics: Images Are More than Pictures, They Are Data](10_1148_radiol_2015151169.md) — Radiomics uses Haralick-style texture features to convert medical images into quantitative image-classification data.
