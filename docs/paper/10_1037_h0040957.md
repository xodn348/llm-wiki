...
- **cite** → [Coefficient Alpha and the Internal Structure of Tests](10_1007_bf02310555.md) — Cronbach's coefficient alpha supplies the internal-consistency reliability criterion used in evaluating construct validity of psychological tests.
- **enables** → [Toward an experimental ecology of human development.](10_1037_0003_066x_32_7_513.md) — Construct validity framed how psychological concepts should be operationalized, supporting Bronfenbrenner's call for ecologically valid developmental research.
- **cite** ← [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — The multitrait-multimethod matrix operationalizes Cronbach and Meehl's construct-validity framework by separating convergent from discriminant evidence.
- **cite** ← [Toward an experimental ecology of human development.](10_1037_0003_066x_32_7_513.md) — Bronfenbrenner invokes construct validity to argue that ecological experiments must measure developmentally meaningful psychological constructs.
