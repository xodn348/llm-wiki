...
- **cite** → [Emerging Photoluminescence in Monolayer MoS<sub>2</sub>](10_1021_nl903868w.md) — Liquid exfoliation of layered materials cites monolayer MoS2 photoluminescence as evidence that exfoliated nanosheets can gain new optical properties.
- **cite** → [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — Liquid exfoliation of layered materials extends the two-dimensional atomic crystal concept to scalable nanosheet production.
- **cite** ← [Two‐Dimensional Nanocrystals Produced by Exfoliation of Ti<sub>3</sub>AlC<sub>2</sub>](10_1002_adma_201102306.md) — The MXene exfoliation paper cites liquid exfoliation of layered materials as a related route for producing two-dimensional nanosheets.
- **cite** ← [Van der Waals heterostructures](10_1038_nature12385.md) — Van der Waals heterostructures cites liquid exfoliation as a scalable method for producing two-dimensional layered building blocks.
- **enables** ← [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — Isolation of graphene and other two-dimensional crystals established layered materials as exfoliable targets for liquid-phase nanosheet production.
