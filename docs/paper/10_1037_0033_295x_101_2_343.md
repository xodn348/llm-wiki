...
- **cite** ← [Nearest neighbor pattern classification](10_1109_tit_1967_1053964.md) — Nearest-neighbor classification cites Miller's capacity limit as psychological context for pattern recognition and human information-processing constraints.
- **cite** ← [The theory of planned behavior](10_1016_0749_5978_91_90020_t.md) — Ajzen cites Miller's limited information-processing capacity to motivate constraints on how many beliefs people can saliently consider.
- **cite** ← [A scaling method for priorities in hierarchical structures](10_1016_0022_2496_77_90033_5.md) — Saaty's hierarchy-scaling method cites Miller's capacity limit to motivate keeping pairwise comparison judgments cognitively manageable.
