...
- **cite** → [Self-efficacy mechanism in human agency.](10_1037_0003_066x_37_2_122.md) — The WEIRD paper cites self-efficacy as an example of a psychological mechanism whose measured effects may vary across sampled populations.
- **cite** → [Culture's Consequences: Comparing Values, Behaviors, Institutions, and Organizations across Nations](10_2307_4134391.md) — The WEIRD paper uses Hofstede's cross-national cultural dimensions to argue that psychological findings are culturally patterned rather than universal.
- **cite** → [Culture and the self: Implications for cognition, emotion, and motivation.](10_1037_0033_295x_98_2_224.md) — The WEIRD paper invokes independent versus interdependent self-construals to explain cultural variation in cognition, emotion, and motivation.
- **cite** ← [Amazon's Mechanical Turk](10_1177_1745691610393980.md) — The Mechanical Turk paper cites WEIRD to frame concerns that online subject pools may not represent broader human populations.
- **enables** ← [Self-efficacy mechanism in human agency.](10_1037_0003_066x_37_2_122.md) — Bandura's self-efficacy construct supplied a psychological mechanism that Henrich et al. used to question whether Western subjects generalize globally.
- **enables** ← [Culture's Consequences: Comparing Values, Behaviors, Institutions, and Organizations across Nations](10_2307_4134391.md) — Hofstede's cross-national value dimensions supplied comparative cultural evidence for Henrich et al.'s claim that WEIRD samples are atypical.
- **enables** ← [Culture and the self: Implications for cognition, emotion, and motivation.](10_1037_0033_295x_98_2_224.md) — Markus and Kitayama's independent-versus-interdependent self construals supplied a core example of culturally variable cognition in the WEIRD critique.
