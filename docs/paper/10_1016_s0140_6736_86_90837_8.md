...
- **enables** → [Bias in meta-analysis detected by a simple, graphical test](10_1136_bmj_315_7109_629.md) — Egger's funnel-plot regression test applies graphical agreement-style reasoning from Bland-Altman plots to detect bias in meta-analysis.
- **cite** ← [Bias in meta-analysis detected by a simple, graphical test](10_1136_bmj_315_7109_629.md) — Egger's meta-analysis bias test links to Bland-Altman by using regression-based graphical diagnostics to detect systematic bias in quantitative evidence.
## Sources
