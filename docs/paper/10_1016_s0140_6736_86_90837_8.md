...
- **enables** → [Bias in meta-analysis detected by a simple, graphical test](10_1136_bmj_315_7109_629.md) — Bland-Altman graphical assessment of measurement bias helped motivate Egger’s graphical regression approach for detecting bias in meta-analysis.
- **cite** ← [Bias in meta-analysis detected by a simple, graphical test](10_1136_bmj_315_7109_629.md) — Egger's funnel-plot regression test builds on Bland-Altman thinking about graphical detection of systematic measurement bias.
