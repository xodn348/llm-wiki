...
- **cite** → [A SIMPLE METHOD FOR THE ISOLATION AND PURIFICATION OF TOTAL LIPIDES FROM ANIMAL TISSUES](10_1016_s0021_9258_18_64849_5.md) — Bligh and Dyer present a faster total-lipid extraction protocol that modifies Folch's chloroform-methanol tissue lipid isolation method.
