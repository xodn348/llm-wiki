...
- **enables** → [Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network](10_1109_cvpr_2017_19.md) — Structural similarity as a perceptual image-quality metric enabled SRGAN to evaluate super-resolution outputs by perceptual fidelity rather than pixel error alone.
- **enables** → [Image Super-Resolution Using Deep Convolutional Networks](10_1109_tpami_2015_2439281.md) — SSIM provided a perceptual image-quality metric that super-resolution methods could use beyond pixelwise error.
- **cite** ← [Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network](10_1109_cvpr_2017_19.md) — SRGAN reports SSIM as a conventional full-reference image-quality metric while arguing perceptual realism is not captured by distortion metrics alone.
- **cite** ← [Image Super-Resolution Using Deep Convolutional Networks](10_1109_tpami_2015_2439281.md) — SRCNN cites SSIM as a perceptual image-quality metric for evaluating super-resolution outputs beyond pixel error.
