...
- **enables** → [Differential expression analysis for sequence count data](10_1186_gb_2010_11_10_r106.md) — limma's empirical Bayes shrinkage of gene-wise variance informed DESeq's use of moderated dispersion estimates for differential expression.
- **cite** ← [Differential expression analysis for sequence count data](10_1186_gb_2010_11_10_r106.md) — DESeq cites limma as the empirical-Bayes differential expression framework that inspired moderated statistical testing in genomics.
