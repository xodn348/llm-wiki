...
- **enables** → [Isolation of a cDNA cLone Derived from a Blood-Borne Non-A, Non-B Viral Hepatitis Genome](10_1126_science_2523562.md) — Southern blotting enabled detection of specific nucleic acid sequences, providing the hybridization logic used to identify hepatitis C cDNA clones.
- **cite** ← [Labeling deoxyribonucleic acid to high specific activity in vitro by nick translation with DNA polymerase I](10_1016_0022_2836_77_90052_3.md) — Nick translation provides high-specific-activity DNA probes for detecting specific gel-separated DNA fragments by Southern blotting.
- **cite** ← [Electrophoretic transfer of proteins from polyacrylamide gels to nitrocellulose sheets: procedure and some applications.](10_1073_pnas_76_9_4350.md) — The protein blotting procedure adapts Southern's gel-transfer and membrane-hybridization concept from DNA fragments to proteins.
- **cite** ← [Isolation of a cDNA cLone Derived from a Blood-Borne Non-A, Non-B Viral Hepatitis Genome](10_1126_science_2523562.md) — The hepatitis C paper relies on Southern blot detection to identify specific viral DNA sequences among electrophoresed cDNA fragments.
