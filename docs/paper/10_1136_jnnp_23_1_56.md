...
- **enables** → [The CES-D Scale](10_1177_014662167700100306.md) — Hamilton's clinician-rated depression scale established standardized depressive symptom measurement that the CES-D adapted into a community self-report format.
- **cite** ← [The CES-D Scale](10_1177_014662167700100306.md) — The CES-D scale draws on Hamilton's clinician-rated depression scale as a source of depressive symptom constructs.
