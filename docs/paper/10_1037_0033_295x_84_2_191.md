...
- **enables** → [The theory of planned behavior](10_1016_0749_5978_91_90020_t.md) — Bandura's self-efficacy theory directly shaped perceived behavioral control as a predictor of intention and behavior.
...
- **cite** ← [The theory of planned behavior](10_1016_0749_5978_91_90020_t.md) — Ajzen connects perceived behavioral control to Bandura's self-efficacy account of how efficacy expectations affect behavioral change.
- **cite** ← [Fostering implementation of health services research findings into practice: a consolidated framework for advancing implementation science](10_1186_1748_5908_4_50.md) — CFIR cites self-efficacy theory to explain how confidence in performing an intervention affects implementation behavior.
