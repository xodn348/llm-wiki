...
- **enables** → [Finding and evaluating community structure in networks](10_1103_physreve_69_026113.md) — Freeman's betweenness centrality supplied the edge-betweenness idea that Girvan and Newman used to detect communities by removing high-betweenness edges.
- **enables** → [The Structure and Function of Complex Networks](10_1137_s003614450342480.md) — Betweenness centrality became one of the core network measures surveyed and generalized in complex network analysis.
- **cite** ← [Centrality in social networks conceptual clarification](10_1016_0378_8733_78_90021_7.md) — Freeman's centrality clarification directly systematizes betweenness centrality measures introduced by Freeman in the 1977 paper.
- **cite** ← [Finding and evaluating community structure in networks](10_1103_physreve_69_026113.md) — Newman and Girvan build their community-detection method around edge betweenness, extending Freeman's betweenness centrality concept from vertices to edges.
- **cite** ← [The Structure and Function of Complex Networks](10_1137_s003614450342480.md) — Newman uses Freeman's betweenness centrality as a core measure for identifying important vertices in complex networks.
