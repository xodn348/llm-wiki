...
- **cite** → [Large Sample Properties of Generalized Method of Moments Estimators](10_2307_1912775.md) — Arellano and Bond use Hansen's generalized method of moments theory to derive dynamic panel-data estimators and specification tests.
- **cite** → [Specification Tests in Econometrics](10_2307_1913827.md) — Arellano and Bond's panel-data diagnostics apply Hausman's specification-testing logic to serial correlation and instrument validity in dynamic panels.
- **enables** ← [Large Sample Properties of Generalized Method of Moments Estimators](10_2307_1912775.md) — Hansen’s GMM asymptotics enabled Arellano and Bond’s panel-data specification tests using moment conditions for dynamic employment equations.
- **enables** ← [Specification Tests in Econometrics](10_2307_1913827.md) — Hausman’s specification-test logic underlies Arellano and Bond’s use of diagnostic tests to detect invalid panel-data estimators and instruments.
