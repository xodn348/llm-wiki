...
- **cite** → [An Analysis of Transformations](10_1111_j_2517_6161_1964_tb00553_x.md) — Fine and Gray rely on Box-Cox-style transformation ideas for modeling transformed cumulative incidence functions in competing risks.
- **cite** → [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Fine and Gray adapt Cox's proportional hazards regression framework to the subdistribution hazard for competing-risk outcomes.
- **enables** → [A Randomized Trial of Intensive versus Standard Blood-Pressure Control](10_1056_nejmoa1511939.md) — The Fine-Gray subdistribution hazards model enabled SPRINT analyses of cardiovascular outcomes in the presence of competing mortality risks.
- **cite** ← [A Randomized Trial of Intensive versus Standard Blood-Pressure Control](10_1056_nejmoa1511939.md) — The SPRINT blood-pressure trial uses Fine and Gray's subdistribution hazards model to analyze outcomes when competing risks such as death affect event incidence.
- **enables** ← [An Analysis of Transformations](10_1111_j_2517_6161_1964_tb00553_x.md) — Box-Cox transformation theory enabled Fine and Gray's competing-risk regression by formalizing how transformed outcome scales can make regression models tractable.
- **enables** ← [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox's proportional hazards model supplied the hazard-regression framework that Fine and Gray adapted to the subdistribution hazard for competing risks.
