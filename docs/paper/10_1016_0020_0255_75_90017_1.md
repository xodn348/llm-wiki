...
- **cite** → [Fuzzy sets](10_1016_s0019_9958_65_90241_x.md) — Zadeh's linguistic variable framework extends his fuzzy sets concept by using fuzzy set membership functions to represent imprecise linguistic terms.
- **enables** ← [Fuzzy sets](10_1016_s0019_9958_65_90241_x.md) — Zadeh's fuzzy-set membership functions enabled linguistic variables to represent words as fuzzy values for approximate reasoning.
