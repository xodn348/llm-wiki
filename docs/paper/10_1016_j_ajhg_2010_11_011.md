...
- **cite** → [Principal components analysis corrects for stratification in genome-wide association studies](10_1038_ng1847.md) — GCTA cites PCA correction for GWAS stratification as a method for controlling population structure in genome-wide genotype analyses.
- **cite** → [PLINK: A Tool Set for Whole-Genome Association and Population-Based Linkage Analyses](10_1086_519795.md) — GCTA cites PLINK as a standard genome-wide association analysis toolkit whose genotype data and workflows complement variance-component estimation.
- **enables** → [LD Score regression distinguishes confounding from polygenicity in genome-wide association studies](10_1038_ng_3211.md) — GCTA's variance-component view of genome-wide heritability set up LD Score regression's use of SNP-level association statistics to separate polygenicity from bias.
- **cite** ← [LD Score regression distinguishes confounding from polygenicity in genome-wide association studies](10_1038_ng_3211.md) — LD Score regression contrasts its summary-statistic heritability and confounding estimates with GCTA's individual-genotype mixed-model approach.
