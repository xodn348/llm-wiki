...
- **cite** → [Isolation of biologically active ribonucleic acid from sources enriched in ribonuclease](10_1021_bi00591a005.md) — Chomczynski and Sacchi's acid guanidinium thiocyanate-phenol-chloroform protocol improves earlier guanidinium-based RNA isolation from RNase-rich tissues.
- **enables** ← [Isolation of biologically active ribonucleic acid from sources enriched in ribonuclease](10_1021_bi00591a005.md) — The guanidinium-based RNase-inactivating RNA extraction principle enabled the later acid guanidinium thiocyanate phenol-chloroform single-step method.
