...
- **cite** → [Measurements of Ω and Λ from 42 High‐Redshift Supernovae](10_1086_307221.md) — WMAP's cosmological-parameter estimates are compared with Type Ia supernova evidence for a universe with nonzero ΩΛ and accelerated expansion.
- **cite** → [Observational Evidence from Supernovae for an Accelerating Universe and a Cosmological Constant](10_1086_300499.md) — WMAP cites the supernova acceleration result as independent evidence for a nonzero cosmological constant in the concordance ΛCDM parameter model.
- **enables** → [<i>Planck</i>2013 results. XVI. Cosmological parameters](10_1051_0004_6361_201321591.md) — WMAP’s first-year CMB parameter estimation established the precision-CMB ΛCDM framework that Planck refined with higher-resolution data.
- **enables** → [SEVEN-YEAR<i>WILKINSON MICROWAVE ANISOTROPY PROBE</i>(<i>WMAP</i>) OBSERVATIONS: COSMOLOGICAL INTERPRETATION](10_1088_0067_0049_192_2_18.md) — The first-year WMAP parameter framework enabled the seven-year WMAP analysis through improved cosmic microwave background constraints.
- **cite** ← [<i>Planck</i>2013 results. XVI. Cosmological parameters](10_1051_0004_6361_201321591.md) — Planck 2013 builds on WMAP first-year CMB anisotropy measurements as an earlier determination of ΛCDM cosmological parameters.
- **cite** ← [SEVEN-YEAR<i>WILKINSON MICROWAVE ANISOTROPY PROBE</i>(<i>WMAP</i>) OBSERVATIONS: COSMOLOGICAL INTERPRETATION](10_1088_0067_0049_192_2_18.md) — WMAP seven-year cosmology extends the first-year WMAP cosmological-parameter analysis with longer microwave background observations.
- **enables** ← [Observational Evidence from Supernovae for an Accelerating Universe and a Cosmological Constant](10_1086_300499.md) — Supernova evidence for cosmic acceleration motivated WMAP's precision test of a flat Lambda-CDM cosmology with dark energy.
