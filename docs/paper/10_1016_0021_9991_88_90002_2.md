...
- **enables** → [Active contours without edges](10_1109_83_902291.md) — Hamilton-Jacobi level-set methods enabled Chan-Vese active contours to evolve curves through topological changes without explicit edge tracking.
- **cite** ← [Nonlinear total variation based noise removal algorithms](10_1016_0167_2789_92_90242_f.md) — Total-variation denoising uses curvature-driven front-propagation and Hamilton-Jacobi numerical ideas developed by Osher and Sethian.
- **cite** ← [Active contours without edges](10_1109_83_902291.md) — Chan-Vese active contours use level-set curve evolution methods rooted in Osher and Sethian's curvature-dependent front-propagation algorithms.
