...
- **cite** → [Robust uncertainty principles: exact signal reconstruction from highly incomplete frequency information](10_1109_tit_2005_862083.md) — Singular value thresholding extends compressed-sensing exact-recovery ideas from sparse Fourier reconstruction to low-rank matrix completion.
- **cite** → [Compressed sensing](10_1109_tit_2006_871582.md) — The matrix-completion algorithm adapts compressed sensing’s principle of recovering structured signals from few measurements to low-rank matrices.
- **cite** ← [Robust principal component analysis?](10_1145_1970392_1970395.md) — Robust PCA relies on singular-value thresholding as a proximal method for nuclear-norm minimization in related low-rank matrix recovery problems.
