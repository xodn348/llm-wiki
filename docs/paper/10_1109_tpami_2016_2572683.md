...
- **cite** → [Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks](10_1109_tpami_2016_2577031.md) — Fully Convolutional Networks cites Faster R-CNN as a contemporary CNN-based detection framework using region proposal networks.
- **cite** → [Going deeper with convolutions](10_1109_cvpr_2015_7298594.md) — Fully Convolutional Networks uses GoogLeNet as an example of deep convolutional architectures adaptable to dense prediction.
- **cite** → [Backpropagation Applied to Handwritten Zip Code Recognition](10_1162_neco_1989_1_4_541.md) — Fully Convolutional Networks traces end-to-end convolutional learning for vision back to LeCun's backpropagation-trained CNNs.
- **enables** ← [Backpropagation Applied to Handwritten Zip Code Recognition](10_1162_neco_1989_1_4_541.md) — LeCun’s convolutional backpropagation for handwritten recognition established trainable convolutional feature hierarchies that fully convolutional networks extended to dense semantic segmentation.
