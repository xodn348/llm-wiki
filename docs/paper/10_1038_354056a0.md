...
- **cite** → [C60: Buckminsterfullerene](10_1038_318162a0.md) — Iijima's carbon nanotube paper links to C60 by extending fullerene carbon chemistry from closed spherical cages to graphitic cylindrical structures.
- **enables** → [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — Carbon nanotubes showed stable atomically thin graphitic structures, helping motivate the search for isolated two-dimensional crystals such as graphene.
- **cite** ← [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — The two-dimensional atomic crystals paper cites carbon nanotube discovery as prior evidence that graphitic carbon can form stable low-dimensional nanostructures.
- **enables** ← [C60: Buckminsterfullerene](10_1038_318162a0.md) — The discovery of C60 showed stable curved graphitic carbon cages, enabling Iijima's interpretation of helical microtubules as related fullerene-like carbon nanostructures.
