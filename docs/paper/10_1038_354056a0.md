...
- **cite** → [C60: Buckminsterfullerene](10_1038_318162a0.md) — Carbon nanotube helicity is linked to C60 by the shared concept that graphitic carbon can form stable curved sp2-bonded fullerene structures.
- **enables** → [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — Carbon nanotube work established stable graphitic carbon nanostructures, helping motivate the isolation and study of atomically thin graphene crystals.
- **cite** ← [Two-dimensional atomic crystals](10_1073_pnas_0502848102.md) — Geim and Novoselov cite Iijima's carbon nanotubes as a graphitic carbon analogue showing that carbon can form stable low-dimensional crystalline structures.
- **enables** ← [C60: Buckminsterfullerene](10_1038_318162a0.md) — The discovery of stable curved sp2 carbon cages in C60 motivated Iijima's interpretation of graphitic carbon microtubules as related closed carbon nanostructures.
