...
- **cite** → [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — The CES-D Scale drew on Beck's depression inventory as a prior self-report symptom measure for depressive affect.
- **cite** → [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — The CES-D Scale used Hamilton's clinician-rated depression scale as a reference point for selecting and validating depressive symptom items.
- **enables** ← [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — The CES-D scale draws on Beck's depression inventory tradition of self-report symptom measurement.
- **enables** ← [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — The CES-D scale builds on Hamilton-style depression rating by adapting depressive symptom assessment for epidemiologic population surveys.
## Sources
