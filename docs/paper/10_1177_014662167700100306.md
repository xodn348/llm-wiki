...
- **cite** → [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — Radloff cites Beck et al.'s depression inventory as an established symptom-item framework informing construction and validation of the CES-D scale.
- **cite** → [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — Radloff cites Hamilton's depression rating scale as a clinician-rated benchmark for validating depressive symptom measurement.
- **enables** ← [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — Beck's Depression Inventory enabled CES-D by establishing self-report symptom items as a quantitative depression screening method.
- **enables** ← [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — Hamilton's clinician-rated depression scale enabled CES-D by defining observable depressive symptom domains later adapted for population screening.
