...
- **cite** → [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — The CES-D scale draws on Beck's depression inventory as an existing symptom-based measure of depressive severity.
- **cite** → [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — The CES-D scale draws on Hamilton's clinician-rated depression scale as a source of depressive symptom constructs.
- **enables** ← [An Inventory for Measuring Depression](10_1001_archpsyc_1961_01710120031004.md) — Beck's Depression Inventory supplied a symptom-based self-report model for quantifying depressive affect that informed the CES-D's population screening items.
- **enables** ← [A RATING SCALE FOR DEPRESSION](10_1136_jnnp_23_1_56.md) — Hamilton's clinician-rated depression scale established standardized depressive symptom measurement that the CES-D adapted into a community self-report format.
