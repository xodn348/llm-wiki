...
- **enables** → [Clinical diagnosis of Alzheimer's disease](10_1212_wnl_34_7_939.md) — The Mini-Mental State Examination supplied a standardized cognitive screening measure, enabling Alzheimer's diagnostic criteria to operationalize dementia assessment.
- **enables** → [Frailty in Older Adults: Evidence for a Phenotype](10_1093_gerona_56_3_m146.md) — The Mini-Mental State exam enabled the frailty phenotype study by providing a standardized cognitive screen for older-adult assessment.
- **cite** ← [Clinical diagnosis of Alzheimer's disease](10_1212_wnl_34_7_939.md) — The Alzheimer's diagnostic criteria cite the Mini-Mental State Examination as a brief cognitive screening tool for assessing dementia.
- **cite** ← [Frailty in Older Adults: Evidence for a Phenotype](10_1093_gerona_56_3_m146.md) — The frailty phenotype study uses the Mini-Mental State Examination to assess cognitive status in older adults.
