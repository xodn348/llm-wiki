...
- **enables** → [Clinical diagnosis of Alzheimer's disease](10_1212_wnl_34_7_939.md) — The Mini-Mental State Examination provided a standardized cognitive screen used in operational clinical criteria for Alzheimer’s disease.
- **enables** → [Frailty in Older Adults: Evidence for a Phenotype](10_1093_gerona_56_3_m146.md) — The Mini-Mental State Examination provided a standardized cognitive-screening measure used to distinguish frailty from cognitive impairment in older adults.
- **cite** ← [Clinical diagnosis of Alzheimer's disease](10_1212_wnl_34_7_939.md) — The Alzheimer's diagnostic criteria cite the Mini-Mental State Examination as a standardized cognitive screening tool.
- **cite** ← [Frailty in Older Adults: Evidence for a Phenotype](10_1093_gerona_56_3_m146.md) — The frailty phenotype paper uses the Mini-Mental State Examination to assess or exclude cognitive impairment in older adults.
