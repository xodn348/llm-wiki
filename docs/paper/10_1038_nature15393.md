...
- **cite** → [An integrated map of genetic variation from 1,092 human genomes](10_1038_nature11632.md) — The 2015 global reference expands the 1000 Genomes integrated map from 1,092 genomes into a broader reference panel of human genetic variation.
- **cite** → [A map of human genome variation from population-scale sequencing](10_1038_nature09534.md) — The 2015 global reference builds on the 1000 Genomes pilot map's population-scale sequencing strategy for cataloging common and rare human variants.
- **cite** → [An integrated encyclopedia of DNA elements in the human genome](10_1038_nature11247.md) — The 1000 Genomes reference connects to ENCODE through its use of ENCODE functional annotations to interpret noncoding human genetic variants.
- **cite** ← [Analysis of protein-coding genetic variation in 60,706 humans](10_1038_nature19057.md) — ExAC builds on the 1000 Genomes global variation reference as a population-genetic baseline for human variant frequencies.
- **cite** ← [The UK Biobank resource with deep phenotyping and genomic data](10_1038_s41586_018_0579_z.md) — The UK Biobank genomic resource cites the 1000 Genomes reference as a comparator and imputation reference for human genetic variation.
- **enables** ← [A map of human genome variation from population-scale sequencing](10_1038_nature09534.md) — The 1000 Genomes pilot map provided the population-scale sequencing framework expanded into the 2015 global reference panel of human genetic variation.
