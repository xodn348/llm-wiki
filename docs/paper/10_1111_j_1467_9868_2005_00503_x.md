...
- **cite** → [Molecular Classification of Cancer: Class Discovery and Class Prediction by Gene Expression Monitoring](10_1126_science_286_5439_531.md) — Elastic Net cites gene-expression cancer classification as a high-dimensional variable-selection setting motivating grouped sparse regression.
- **cite** → [Regression Shrinkage and Selection Via the Lasso](10_1111_j_2517_6161_1996_tb02080_x.md) — Elastic Net extends the Lasso by combining L1 sparsity with L2 shrinkage to improve selection under correlated predictors.
- **enables** ← [Molecular Classification of Cancer: Class Discovery and Class Prediction by Gene Expression Monitoring](10_1126_science_286_5439_531.md) — Gene-expression cancer classification posed the high-dimensional, correlated-predictor setting that elastic net regularization was designed to handle.
- **enables** ← [Regression Shrinkage and Selection Via the Lasso](10_1111_j_2517_6161_1996_tb02080_x.md) — The lasso's L1 shrinkage-and-selection penalty is the direct foundation that elastic net extends with an added L2 penalty.
