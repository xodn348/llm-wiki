...
- **enables** → [The CES-D Scale](10_1177_014662167700100306.md) — Beck's Depression Inventory supplied a symptom-based self-report model for quantifying depressive affect that informed the CES-D's population screening items.
- **cite** ← [The CES-D Scale](10_1177_014662167700100306.md) — The CES-D scale draws on Beck's depression inventory as an existing symptom-based measure of depressive severity.
