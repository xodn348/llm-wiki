...
- **enables** → [The CES-D Scale](10_1177_014662167700100306.md) — Beck's Depression Inventory enabled CES-D by establishing self-report symptom items as a quantitative depression screening method.
- **cite** ← [The CES-D Scale](10_1177_014662167700100306.md) — Radloff cites Beck et al.'s depression inventory as an established symptom-item framework informing construction and validation of the CES-D scale.
