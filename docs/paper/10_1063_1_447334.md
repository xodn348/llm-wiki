...
- **cite** → [Polymorphic transitions in single crystals: A new molecular dynamics method](10_1063_1_328693.md) — The unified constant-temperature molecular dynamics formulation builds on Andersen's method for simulating polymorphic transitions under controlled thermodynamic conditions.
- **enables** → [Projector augmented-wave method](10_1103_physrevb_50_17953.md) — Constant-temperature molecular dynamics supplied thermostat methods later used with first-principles electronic-structure simulations such as PAW-based molecular dynamics.
- **cite** ← [Canonical dynamics: Equilibrium phase-space distributions](10_1103_physreva_31_1695.md) — Nosé's 1985 canonical dynamics reformulates the constant-temperature extended-system molecular dynamics introduced in the 1984 unified formulation.
- **cite** ← [Projector augmented-wave method](10_1103_physrevb_50_17953.md) — The PAW method cites Nose's constant-temperature molecular dynamics as part of the simulation toolkit used with first-principles electronic-structure methods.
