...
- **enables** → [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — AlexNet replaced earlier hand-engineered or ensemble classifiers such as random forests with end-to-end learned convolutional features for ImageNet recognition.
- **enables** → [XGBoost](10_1145_2939672_2939785.md) — XGBoost extends the decision-tree ensemble idea popularized by Random Forests with gradient-boosted trees, regularization, and scalable training.
- **cite** ← [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — AlexNet links to Random Forests by contrasting deep learned visual features with earlier machine-learning classifiers used for recognition tasks.
- **cite** ← [XGBoost](10_1145_2939672_2939785.md) — XGBoost contrasts gradient-boosted decision trees with Breiman's random forests as an alternative ensemble tree method.
## Sources
