...
- **cite** → [Bagging Predictors](10_1023_a_1018054314350.md) — Random forests extend bagging by training many decision trees on bootstrap samples while adding random feature selection at each split.
- **enables** → [XGBoost](10_1145_2939672_2939785.md) — Random Forests popularized ensemble decision trees, enabling XGBoost to position boosted trees as a competing high-performance ensemble method.
- **enables** → [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — Random Forests provided a strong pre-deep-learning ensemble baseline that contextualized the performance gains of convolutional neural networks on ImageNet.
- **cite** ← [XGBoost](10_1145_2939672_2939785.md) — XGBoost uses ensembles of decision trees, linking it to Random Forests through tree-based aggregation for predictive modeling.
- **cite** ← [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — The ImageNet convolutional-network paper cites random forests as a contrasting machine-learning approach for classification.
- **enables** ← [Bagging Predictors](10_1023_a_1018054314350.md) — Bagging's bootstrap aggregation of unstable predictors is the ensemble foundation that Random Forests extends with random feature selection.
