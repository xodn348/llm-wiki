...
- **enables** → [Optimization by Simulated Annealing](10_1126_science_220_4598_671.md) — Simulated annealing adapts the Metropolis Monte Carlo acceptance rule from statistical physics simulations to probabilistic optimization.
- **cite** ← [Optimization by Simulated Annealing](10_1126_science_220_4598_671.md) — Simulated annealing imports the Metropolis Monte Carlo acceptance rule from statistical mechanics into combinatorial optimization.
## Sources
