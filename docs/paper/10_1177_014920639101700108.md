...
- **cite** → [A resource‐based view of the firm](10_1002_smj_4250050207.md) — Barney's sustained competitive advantage paper formalizes Wernerfelt's resource-based view into the VRIN claim that valuable, rare, imperfectly imitable, and non-substitutable resources can sustain advantage.
- **enables** → [Dynamic capabilities: what are they?](10_1002_1097_0266_200010_11_21_10_11_1105__aid_smj133_3_0_co_2_e.md) — Barney's VRIN resource logic frames the sustained-advantage problem that dynamic capabilities address in changing environments.
- **cite** ← [Dynamic capabilities: what are they?](10_1002_1097_0266_200010_11_21_10_11_1105__aid_smj133_3_0_co_2_e.md) — Winter connects dynamic capabilities to Barney's VRIN resource logic by asking how firms create and renew resources that sustain advantage.
- **enables** ← [A resource‐based view of the firm](10_1002_smj_4250050207.md) — Wernerfelt's resource-based view introduced firm resources as sources of advantage, which Barney formalized into the VRIN criteria for sustained competitive advantage.
