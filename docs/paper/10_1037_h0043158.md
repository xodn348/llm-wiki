...
- **enables** → [The theory of planned behavior](10_1016_0749_5978_91_90020_t.md) — Miller's capacity limit for information processing supported Ajzen's use of compact expectancy-value belief sets to model attitudes, norms, and control.
- **enables** → [A scaling method for priorities in hierarchical structures](10_1016_0022_2496_77_90033_5.md) — Miller's limit on human information processing motivates Saaty's hierarchical pairwise-comparison method for reducing priority judgments.
- **cite** ← [The theory of planned behavior](10_1016_0749_5978_91_90020_t.md) — Ajzen cites Miller's memory-capacity paper to support limiting the number of salient beliefs used in expectancy-value measures.
- **cite** ← [A scaling method for priorities in hierarchical structures](10_1016_0022_2496_77_90033_5.md) — Saaty's analytic hierarchy process uses Miller's cognitive-capacity limit to motivate manageable pairwise-comparison structures.
