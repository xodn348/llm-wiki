...
- **cite** → [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — RELION adapts the expectation-maximization framework of Dempster, Laird, and Rubin to estimate cryo-EM particle orientations and structures under incomplete data.
- **enables** ← [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — The EM algorithm provides the incomplete-data maximum-likelihood logic underlying RELION's Bayesian cryo-EM refinement.
