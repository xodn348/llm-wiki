...
- **cite** → [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — Clinical-trial meta-analysis uses maximum-likelihood and incomplete-data reasoning closely associated with the EM algorithm.
- **enables** ← [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — The EM algorithm supplied maximum-likelihood machinery for incomplete-data models, supporting pooled-effect estimation in clinical-trial meta-analysis.
## Sources
