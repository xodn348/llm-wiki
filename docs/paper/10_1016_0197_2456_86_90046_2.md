...
- **cite** → [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — Meta-analysis in clinical trials is linked to the EM algorithm through maximum-likelihood estimation with incomplete study data.
- **enables** ← [Maximum Likelihood from Incomplete Data Via the <i>EM</i> Algorithm](10_1111_j_2517_6161_1977_tb01600_x.md) — The EM algorithm provided a likelihood-based way to estimate parameters with incomplete data, enabling meta-analysis methods to combine partially observed clinical-trial evidence.
