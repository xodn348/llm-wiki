...
- **cite** → [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — PAW links to Kohn-Sham by providing an all-electron reconstruction method for solving Kohn-Sham density-functional equations efficiently.
- **enables** ← [Self-Consistent Equations Including Exchange and Correlation Effects](10_1103_physrev_140_a1133.md) — The projector augmented-wave method is formulated within the Kohn-Sham density-functional theory framework for electronic-structure calculations.
## Sources
