...
- **enables** → [The Protein Data Bank](10_1093_nar_28_1_235.md) — BLAST enabled fast sequence-similarity searches that helped annotate and compare protein sequences associated with Protein Data Bank structures.
- **cite** ← [The Protein Data Bank](10_1093_nar_28_1_235.md) — The Protein Data Bank links deposited protein structures to sequence-similarity searches using BLAST.
## Sources
