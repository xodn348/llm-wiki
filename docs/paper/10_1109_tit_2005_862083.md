...
- **cite** → [Nonlinear total variation based noise removal algorithms](10_1016_0167_2789_92_90242_f.md) — Compressed sensing reconstruction cites total variation denoising because sparsity in image gradients enables recovery from incomplete data.
- **enables** → [Robust principal component analysis?](10_1145_1970392_1970395.md) — Compressed sensing's sparsity-based exact recovery principles enabled robust PCA's guarantee that sparse corruptions can be separated from low-rank structure.
- **cite** ← [Compressed sensing](10_1109_tit_2006_871582.md) — Compressed sensing cites robust uncertainty principles for the result that sparse signals can be exactly reconstructed from highly incomplete frequency measurements.
- **cite** ← [Robust principal component analysis?](10_1145_1970392_1970395.md) — Robust PCA builds on compressed-sensing uncertainty principles showing exact recovery from incomplete information under incoherence conditions.
- **cite** ← [A Singular Value Thresholding Algorithm for Matrix Completion](10_1137_080738970.md) — Singular value thresholding extends compressed-sensing exact-recovery ideas from sparse Fourier reconstruction to low-rank matrix completion.
- **enables** ← [Nonlinear total variation based noise removal algorithms](10_1016_0167_2789_92_90242_f.md) — Total-variation regularization showed sparse-gradient image recovery, helping set the stage for compressed sensing’s exact recovery from incomplete measurements.
