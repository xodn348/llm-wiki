...
- **cite** → [Distinctive Image Features from Scale-Invariant Keypoints](10_1023_b_visi_0000029664_99615_94.md) — ImageNet links to SIFT by using local invariant image descriptors as part of the pre-deep-learning visual recognition context.
- **enables** → [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — AlexNet demonstrates deep convolutional image classification on the large labeled ImageNet benchmark dataset.
- **enables** → [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — The ImageNet dataset provided the labeled image hierarchy and benchmark corpus that became the basis for the ImageNet Large Scale Visual Recognition Challenge.
- **cite** ← [ImageNet classification with deep convolutional neural networks](10_1145_3065386.md) — AlexNet links to ImageNet by using the large-scale labeled image dataset as the benchmark for supervised CNN classification.
- **cite** ← [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — ILSVRC is built directly on the ImageNet hierarchical image database as its large-scale classification and detection benchmark.
- **enables** ← [Distinctive Image Features from Scale-Invariant Keypoints](10_1023_b_visi_0000029664_99615_94.md) — ImageNet's visual recognition benchmark was built in a field where SIFT-style local image descriptors were a dominant feature representation.
## Sources
