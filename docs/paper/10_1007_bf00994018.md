...
- **cite** → [Learning representations by back-propagating errors](10_1038_323533a0.md) — Support-vector networks contrast margin-based kernel learning with back-propagation-trained neural networks as approaches to supervised pattern recognition.
- **cite** → [A training algorithm for optimal margin classifiers](10_1145_130385_130401.md) — Support-vector networks develop the optimal-margin classifier idea from Boser, Guyon, and Vapnik into the broader support-vector machine framework with kernels.
- **enables** ← [Learning representations by back-propagating errors](10_1038_323533a0.md) — Back-propagation popularized gradient-based representation learning, while support-vector networks pursued margin-based classification as an alternative supervised learning framework.
