...
- **cite** → [Learning representations by back-propagating errors](10_1038_323533a0.md) — Support-vector networks cite back-propagation as a dominant neural-network learning method that SVMs contrast with through convex margin-based optimization.
- **cite** → [A training algorithm for optimal margin classifiers](10_1145_130385_130401.md) — Support-vector networks directly extend optimal margin classifiers by introducing kernel-based nonlinear decision surfaces within the maximum-margin framework.
- **enables** ← [Learning representations by back-propagating errors](10_1038_323533a0.md) — Back-propagation popularized gradient-based supervised learning, the optimization setting in which support-vector networks offered a margin-based alternative.
