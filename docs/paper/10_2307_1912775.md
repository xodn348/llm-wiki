...
- **cite** → [A Heteroskedasticity-Consistent Covariance Matrix Estimator and a Direct Test for Heteroskedasticity](10_2307_1912934.md) — GMM large-sample theory uses heteroskedasticity-consistent covariance estimation to justify robust inference under unknown error variance.
- **enables** → [Some Tests of Specification for Panel Data: Monte Carlo Evidence and an Application to Employment Equations](10_2307_2297968.md) — Hansen’s GMM asymptotics enabled Arellano and Bond’s panel-data specification tests using moment conditions for dynamic employment equations.
- **cite** ← [Some Tests of Specification for Panel Data: Monte Carlo Evidence and an Application to Employment Equations](10_2307_2297968.md) — Arellano and Bond use Hansen's generalized method of moments theory to derive dynamic panel-data estimators and specification tests.
