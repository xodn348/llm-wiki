...
- **cite** → [STATISTICAL METHODS FOR ASSESSING AGREEMENT BETWEEN TWO METHODS OF CLINICAL MEASUREMENT](10_1016_s0140_6736_86_90837_8.md) — Egger's funnel-plot regression test builds on Bland-Altman thinking about graphical detection of systematic measurement bias.
- **cite** → [The Effect of Intensive Treatment of Diabetes on the Development and Progression of Long-Term Complications in Insulin-Dependent Diabetes Mellitus](10_1056_nejm199309303291401.md) — Egger's meta-analysis bias paper uses large clinical trial evidence such as the DCCT diabetes study as context for trial synthesis.
- **enables** ← [STATISTICAL METHODS FOR ASSESSING AGREEMENT BETWEEN TWO METHODS OF CLINICAL MEASUREMENT](10_1016_s0140_6736_86_90837_8.md) — Bland-Altman graphical assessment of measurement bias helped motivate Egger’s graphical regression approach for detecting bias in meta-analysis.
