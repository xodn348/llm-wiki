...
- **cite** → [Bootstrap Methods: Another Look at the Jackknife](10_1214_aos_1176344552.md) — Felsenstein applies Efron's bootstrap resampling method to estimate confidence limits for phylogenetic trees.
- **enables** ← [Bootstrap Methods: Another Look at the Jackknife](10_1214_aos_1176344552.md) — Efron’s bootstrap resampling method enabled Felsenstein to assign confidence limits to phylogenetic tree branches by resampling characters.
