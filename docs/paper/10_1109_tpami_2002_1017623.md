...
- **enables** → [Selective Search for Object Recognition](10_1007_s11263_013_0620_5.md) — Local binary patterns provided a compact texture descriptor, and Selective Search explicitly uses texture similarity as one cue for merging image regions.
- **cite** ← [Selective Search for Object Recognition](10_1007_s11263_013_0620_5.md) — Selective Search uses local binary pattern texture cues as one of the region-similarity signals for merging segments.
