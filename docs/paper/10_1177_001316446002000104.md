...
- **enables** → [The Measurement of Observer Agreement for Categorical Data](10_2307_2529310.md) — Cohen's kappa introduced chance-corrected nominal agreement, which the 1977 paper generalized and analyzed for categorical observer data.
- **cite** ← [The Measurement of Observer Agreement for Categorical Data](10_2307_2529310.md) — Fleiss's kappa generalizes Cohen's nominal-scale agreement coefficient from two raters to multiple observers.
