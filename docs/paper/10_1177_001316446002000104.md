...
- **enables** → [The Measurement of Observer Agreement for Categorical Data](10_2307_2529310.md) — Landis and Koch interpret categorical observer agreement using Cohen's kappa statistic for nominal scales.
- **cite** ← [The Measurement of Observer Agreement for Categorical Data](10_2307_2529310.md) — The observer-agreement paper links to Cohen's kappa by extending chance-corrected agreement measurement for categorical ratings.
## Sources
