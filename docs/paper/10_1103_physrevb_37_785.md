...
- **cite** → [Density-functional approximation for the correlation energy of the inhomogeneous electron gas](10_1103_physrevb_33_8822.md) — The Lee-Yang-Parr density functional develops the Colle-Salvetti correlation formula using density-functional ideas for inhomogeneous electron-gas correlation.
