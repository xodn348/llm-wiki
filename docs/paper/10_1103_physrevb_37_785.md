...
- **cite** → [Density-functional approximation for the correlation energy of the inhomogeneous electron gas](10_1103_physrevb_33_8822.md) — Lee, Yang, and Parr adapt Perdew and Wang's inhomogeneous-electron-gas correlation approximation into the LYP electron-density functional.
