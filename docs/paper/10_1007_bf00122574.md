...
- **cite** → [Judgment under Uncertainty: Heuristics and Biases](10_1007_978_94_010_1834_0_8.md) — Cumulative prospect theory builds on heuristics-and-biases evidence that probability judgments under uncertainty systematically deviate from expected-utility assumptions.
- **cite** → [Prospect Theory: An Analysis of Decision under Risk](10_2307_1914185.md) — Cumulative prospect theory revises the original prospect theory value function and probability-weighting account for risky choice.
- **enables** ← [Judgment under Uncertainty: Heuristics and Biases](10_1007_978_94_010_1834_0_8.md) — Heuristics-and-biases evidence about probability judgment motivates cumulative prospect theory's nonlinear probability weighting.
- **enables** ← [Prospect Theory: An Analysis of Decision under Risk](10_2307_1914185.md) — Cumulative prospect theory extends original prospect theory by replacing decision weights with rank-dependent cumulative probability weighting.
