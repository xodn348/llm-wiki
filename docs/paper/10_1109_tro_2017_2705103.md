...
- **cite** → [ORB-SLAM: A Versatile and Accurate Monocular SLAM System](10_1109_tro_2015_2463671.md) — ORB-SLAM2 extends ORB-SLAM from monocular SLAM to stereo and RGB-D cameras while retaining ORB feature-based mapping.
- **cite** → [Vision meets robotics: The KITTI dataset](10_1177_0278364913491297.md) — ORB-SLAM2 uses the KITTI dataset as a benchmark for evaluating visual SLAM on real driving sequences.
