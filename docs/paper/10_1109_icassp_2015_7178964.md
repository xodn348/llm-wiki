...
- **cite** → [Identification of common molecular subsequences](10_1016_0022_2836_81_90087_5.md) — LibriSpeech cites longest-common-subsequence style sequence matching as an algorithmic tool relevant to aligning and filtering text-audio transcripts.
- **enables** ← [Identification of common molecular subsequences](10_1016_0022_2836_81_90087_5.md) — Common subsequence algorithms enabled sequence-alignment style text matching used to align audiobook audio with public-domain transcripts in LibriSpeech.
