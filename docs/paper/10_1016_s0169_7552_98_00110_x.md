...
- **enables** → [The Structure and Function of Complex Networks](10_1137_s003614450342480.md) — PageRank and Web hyperlink structure provided a large-scale directed-network example for complex network theory.
- **cite** ← [The Structure and Function of Complex Networks](10_1137_s003614450342480.md) — Newman links network centrality and Web structure to Brin and Page's PageRank-based analysis of the hyperlink graph.
