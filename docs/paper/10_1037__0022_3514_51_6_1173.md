...
- **cite** → [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — Baron and Kenny cite the multitrait-multimethod matrix as a validity framework for distinguishing mediation and moderation constructs.
- **enables** → [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — Baron and Kenny's moderator-mediator framework enabled Edmondson to test whether psychological safety mediated links between team context and learning behavior.
- **cite** ← [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — Edmondson uses Baron and Kenny's moderator-mediator framework to test how psychological safety relates to team learning behavior and performance.
- **enables** ← [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — The multitrait-multimethod framework established discriminant validity logic that Baron and Kenny applied to distinguish moderator and mediator variables.
