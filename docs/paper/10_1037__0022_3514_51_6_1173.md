...
- **cite** → [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — Baron and Kenny draw on multitrait-multimethod validation to distinguish conceptual relations among variables from measurement artifacts.
- **enables** → [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — Baron and Kenny's mediator-moderator framework underpins Edmondson's tests of psychological safety as a team-level predictor of learning behavior.
- **cite** ← [Psychological Safety and Learning Behavior in Work Teams](10_2307_2666999.md) — Edmondson's team-learning model uses Baron and Kenny's moderator-mediator distinction to test whether psychological safety mediates or moderates learning behavior.
- **enables** ← [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — The multitrait-multimethod matrix formalized construct validation logic that underpins Baron and Kenny's distinction between mediator and moderator variables.
