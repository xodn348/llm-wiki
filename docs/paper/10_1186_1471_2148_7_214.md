...
- **cite** → [Equation of State Calculations by Fast Computing Machines](10_1063_1_1699114.md) — BEAST cites the Metropolis fast-computing-machines paper as the origin of the Metropolis Monte Carlo algorithm used for Bayesian sampling over phylogenetic trees.
- **cite** → [Monte Carlo sampling methods using Markov chains and their applications](10_1093_biomet_57_1_97.md) — BEAST uses Markov chain Monte Carlo sampling, the method formalized by Hastings, to approximate posterior distributions of evolutionary trees.
- **enables** ← [Equation of State Calculations by Fast Computing Machines](10_1063_1_1699114.md) — The Metropolis Monte Carlo algorithm enabled stochastic sampling of complex probability distributions, which BEAST uses for Bayesian phylogenetic inference.
- **enables** ← [Monte Carlo sampling methods using Markov chains and their applications](10_1093_biomet_57_1_97.md) — Markov chain Monte Carlo supplied the posterior-sampling machinery that BEAST applies to jointly estimate phylogenetic trees and evolutionary parameters.
