...
- **enables** → [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Mantel-Haenszel retrospective disease analysis established covariate-adjusted risk estimation that Cox regression generalized to survival data.
- **cite** ← [Regression Models and Life-Tables](10_1111_j_2517_6161_1972_tb00899_x.md) — Cox's proportional hazards model extends Mantel and Haenszel's retrospective disease-risk analysis toward regression-based estimation of covariate effects on survival.
