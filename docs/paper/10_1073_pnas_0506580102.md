...
- **enables** → [Spatial reconstruction of single-cell gene expression data](10_1038_nbt_3192.md) — Gene set enrichment analysis links them through marker-gene pathway interpretation used to infer tissue regions from single-cell expression profiles.
- **cite** ← [Spatial reconstruction of single-cell gene expression data](10_1038_nbt_3192.md) — Spatial reconstruction of single-cell expression uses gene set enrichment analysis to interpret spatially patterned transcriptional programs.
