...
- **cite** ← [Statistical analysis of cointegration vectors](10_1016_0165_1889_88_90041_3.md) — Johansen formalizes estimation and testing of cointegration vectors for the error-correction framework introduced by Engle and Granger.
- **cite** ← [MAXIMUM LIKELIHOOD ESTIMATION AND INFERENCE ON COINTEGRATION — WITH APPLICATIONS TO THE DEMAND FOR MONEY](10_1111_j_1468_0084_1990_mp52002003_x.md) — Johansen's 1990 maximum-likelihood framework builds on Engle and Granger's cointegration/error-correction representation theorem.
