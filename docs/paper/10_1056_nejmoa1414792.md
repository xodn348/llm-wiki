...
- **cite** → [A Simple Sequentially Rejective Multiple Test Procedure](10_2307_4615733.md) — The stroke trial cites Holm's sequentially rejective procedure for controlling familywise error across multiple statistical tests.
- **cite** → [A Randomized Trial of Intraarterial Treatment for Acute Ischemic Stroke](10_1056_nejmoa1411587.md) — The perfusion-imaging stroke trial contrasts its patient-selection and endovascular-treatment results with MR CLEAN's randomized intraarterial therapy evidence.
- **enables** ← [A Simple Sequentially Rejective Multiple Test Procedure](10_2307_4615733.md) — Holm's sequential rejection procedure provides a family-wise error control method relevant to multiple outcome and subgroup tests in perfusion-selected stroke trials.
