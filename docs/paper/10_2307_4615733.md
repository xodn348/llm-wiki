...
- **enables** → [Endovascular Therapy for Ischemic Stroke with Perfusion-Imaging Selection](10_1056_nejmoa1414792.md) — Holm's sequential rejection procedure provides a family-wise error control method relevant to multiple outcome and subgroup tests in perfusion-selected stroke trials.
- **enables** → [Controlling the False Discovery Rate: A Practical and Powerful Approach to Multiple Testing](10_1111_j_2517_6161_1995_tb02031_x.md) — Holm's stepwise multiple-testing correction established sequential error-control logic that Benjamini-Hochberg relaxed from family-wise error to false discovery rate.
- **cite** ← [Endovascular Therapy for Ischemic Stroke with Perfusion-Imaging Selection](10_1056_nejmoa1414792.md) — The stroke trial cites Holm's sequentially rejective procedure for controlling familywise error across multiple statistical tests.
- **cite** ← [Controlling the False Discovery Rate: A Practical and Powerful Approach to Multiple Testing](10_1111_j_2517_6161_1995_tb02031_x.md) — Benjamini and Hochberg contrast false discovery rate control with Holm's sequentially rejective procedure for family-wise error control.
