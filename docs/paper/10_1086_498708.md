...
- **cite** → [The Sloan Digital Sky Survey: Technical Summary](10_1086_301513.md) — 2MASS cites SDSS as a complementary large-area digital sky survey, contrasting its near-infrared all-sky catalog with SDSS optical imaging and spectroscopy.
- **enables** → [<i>Gaia</i> Data Release 2](10_1051_0004_6361_201833051.md) — 2MASS near-infrared all-sky catalog data complemented Gaia astrometry for cross-matching and stellar-source characterization in Gaia Data Release 2.
- **cite** ← [THE WIDE-FIELD INFRARED SURVEY EXPLORER (WISE): MISSION DESCRIPTION AND INITIAL ON-ORBIT PERFORMANCE](10_1088_0004_6256_140_6_1868.md) — WISE cites 2MASS as the earlier near-infrared all-sky survey that provides complementary source catalogs and photometric context.
- **cite** ← [<i>Gaia</i> Data Release 2](10_1051_0004_6361_201833051.md) — Gaia DR2 uses 2MASS near-infrared all-sky photometry as an external cross-match and calibration reference.
- **enables** ← [The Sloan Digital Sky Survey: Technical Summary](10_1086_301513.md) — The SDSS technical summary exemplified large-scale digital sky-survey design and data products, paralleling 2MASS's all-sky survey infrastructure and catalog goals.
