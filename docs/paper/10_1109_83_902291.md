...
- **cite** → [Fronts propagating with curvature-dependent speed: Algorithms based on Hamilton-Jacobi formulations](10_1016_0021_9991_88_90002_2.md) — Chan-Vese active contours use level-set curve evolution methods rooted in Osher and Sethian's curvature-dependent front-propagation algorithms.
- **cite** → [Nonlinear total variation based noise removal algorithms](10_1016_0167_2789_92_90242_f.md) — Chan-Vese active contours draw on Rudin-Osher-Fatemi total-variation regularization to penalize contour length and favor piecewise-smooth regions.
- **cite** → [Snakes: Active contour models](10_1007_bf00133570.md) — Active contours without edges reformulates Kass, Witkin, and Terzopoulos's snakes by driving contours with region statistics instead of image edges.
- **enables** ← [Fronts propagating with curvature-dependent speed: Algorithms based on Hamilton-Jacobi formulations](10_1016_0021_9991_88_90002_2.md) — Hamilton-Jacobi level-set methods enabled Chan-Vese active contours to evolve curves through topological changes without explicit edge tracking.
- **enables** ← [Nonlinear total variation based noise removal algorithms](10_1016_0167_2789_92_90242_f.md) — Total-variation denoising enabled the variational regularization framework used by Chan-Vese segmentation to favor smooth regions.
- **enables** ← [Snakes: Active contour models](10_1007_bf00133570.md) — Snakes introduced energy-minimizing active contours, which Chan-Vese generalized to region-based segmentation without relying on image edges.
