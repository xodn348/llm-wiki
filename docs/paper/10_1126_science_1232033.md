...
- **cite** → [A Programmable Dual-RNA–Guided DNA Endonuclease in Adaptive Bacterial Immunity](10_1126_science_1225829.md) — Human Cas9 genome engineering adapts the dual-RNA-guided Cas9 endonuclease mechanism characterized in bacterial adaptive immunity.
- **cite** → [Multiplex Genome Engineering Using CRISPR/Cas Systems](10_1126_science_1231143.md) — Both CRISPR papers show programmable Cas9 genome editing in human cells, with the cited work demonstrating multiplex targeting.
- **cite** → [Ultrafast and memory-efficient alignment of short DNA sequences to the human genome](10_1186_gb_2009_10_3_r25.md) — The Cas9 genome-engineering study uses Bowtie short-read alignment to map sequencing reads from edited genomic loci.
- **cite** ← [Genome engineering using the CRISPR-Cas9 system](10_1038_nprot_2013_143.md) — The genome-engineering protocol cites RNA-guided Cas9 editing in human cells as direct evidence that CRISPR-Cas9 can target mammalian genomes.
- **cite** ← [Multiplex Genome Engineering Using CRISPR/Cas Systems](10_1126_science_1231143.md) — Cong et al. extend Cas9 human genome editing from single-guide demonstrations to multiplex genome engineering with multiple guide RNAs.
