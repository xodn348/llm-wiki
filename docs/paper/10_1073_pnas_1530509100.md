...
- **enables** → [The GTEx Consortium atlas of genetic regulatory effects across human tissues](10_1126_science_aaz1776.md) — Genomewide significance testing supplied multiple-testing principles used to assess regulatory-effect associations in the GTEx atlas.
- **enables** → [The Genotype-Tissue Expression (GTEx) pilot analysis: Multitissue gene regulation in humans](10_1126_science_1262110.md) — Genomewide significance thresholds shaped GTEx's statistical standards for detecting many genotype-expression associations across tissues.
- **cite** ← [The GTEx Consortium atlas of genetic regulatory effects across human tissues](10_1126_science_aaz1776.md) — The 2020 GTEx atlas relies on genome-wide significance and multiple-testing principles associated with large-scale genetic association studies.
- **cite** ← [The Genotype-Tissue Expression (GTEx) pilot analysis: Multitissue gene regulation in humans](10_1126_science_1262110.md) — GTEx pilot cites genomewide significance thresholds to justify multiple-testing standards for eQTL discovery.
