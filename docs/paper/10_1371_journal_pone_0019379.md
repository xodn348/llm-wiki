...
- **cite** → [Fast and accurate short read alignment with Burrows–Wheeler transform](10_1093_bioinformatics_btp324.md) — The GBS genotyping pipeline uses BWA's Burrows-Wheeler short-read alignment to map sequencing reads to reference genomes.
- **cite** → [Gapped BLAST and PSI-BLAST: a new generation of protein database search programs](10_1093_nar_25_17_3389.md) — The GBS approach cites gapped BLAST and PSI-BLAST as established sequence-similarity search tools for aligning and identifying DNA fragments.
- **enables** ← [Gapped BLAST and PSI-BLAST: a new generation of protein database search programs](10_1093_nar_25_17_3389.md) — BLAST-style sequence alignment enabled GBS pipelines to place short restriction-site reads against reference genomes for SNP discovery and genotyping.
