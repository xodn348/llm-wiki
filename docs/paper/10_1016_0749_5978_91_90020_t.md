...
- **cite** → [Coefficient Alpha and the Internal Structure of Tests](10_1007_bf02310555.md) — The theory of planned behavior links to Cronbach alpha through reliability assessment of multi-item scales measuring attitudes, norms, and perceived control.
- **cite** → [Self-efficacy: Toward a unifying theory of behavioral change.](10_1037_0033_295x_84_2_191.md) — The theory of planned behavior links to self-efficacy by incorporating perceived behavioral control as a related predictor of intentional action.
- **enables** ← [Coefficient Alpha and the Internal Structure of Tests](10_1007_bf02310555.md) — Cronbach's alpha provides the internal-consistency reliability measure used to validate multi-item attitude and intention scales in planned-behavior research.
- **enables** ← [Self-efficacy: Toward a unifying theory of behavioral change.](10_1037_0033_295x_84_2_191.md) — Ajzen's perceived behavioral control construct in the theory of planned behavior is closely linked to Bandura's self-efficacy concept.
## Sources
