...
- **cite** → [The Protein Data Bank](10_1093_nar_28_1_235.md) — The FAIR principles cite the Protein Data Bank as an exemplar of persistent, reusable scientific data infrastructure.
- **enables** ← [The Protein Data Bank](10_1093_nar_28_1_235.md) — The Protein Data Bank exemplified persistent, reusable biological data infrastructure, enabling the FAIR Principles' later formalization of findable, accessible, interoperable, and reusable scientific data.
