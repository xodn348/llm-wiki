...
- **cite** → [Raman Spectrum of Graphene and Graphene Layers](10_1103_physrevlett_97_187401.md) — The copper-foil CVD graphene paper uses Raman spectral signatures established by the 2006 Raman graphene study to verify graphene layer number and quality.
- **cite** ← [Van der Waals heterostructures](10_1038_nature12385.md) — Van der Waals heterostructures cites copper-foil CVD graphene as a scalable source of large-area graphene layers for stacking into atomically thin assemblies.
