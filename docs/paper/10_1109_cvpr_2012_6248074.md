...
- **cite** → [Histograms of Oriented Gradients for Human Detection](10_1109_cvpr_2005_177.md) — KITTI cites HOG because histograms of oriented gradients were a standard visual feature baseline for object and pedestrian detection.
- **cite** ← [Vision meets robotics: The KITTI dataset](10_1177_0278364913491297.md) — The KITTI dataset paper extends the earlier KITTI benchmark suite by documenting the autonomous-driving sensor dataset and its vision tasks in greater detail.
- **enables** ← [Histograms of Oriented Gradients for Human Detection](10_1109_cvpr_2005_177.md) — HOG provided a standard feature-based pedestrian-detection baseline that KITTI used to benchmark autonomous-driving vision systems.
