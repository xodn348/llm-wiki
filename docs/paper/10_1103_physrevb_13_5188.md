...
- **enables** → [Phosphorene: An Unexplored 2D Semiconductor with a High Hole Mobility](10_1021_nn501226z.md) — Monkhorst-Pack special k-point sampling enabled Brillouin-zone integrations used in first-principles calculations of phosphorene properties.
- **cite** ← [Phosphorene: An Unexplored 2D Semiconductor with a High Hole Mobility](10_1021_nn501226z.md) — The phosphorene study uses Monkhorst-Pack special k-point sampling for Brillouin-zone integration in its first-principles electronic-structure calculations.
