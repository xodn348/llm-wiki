...
- **cite** → [A Coefficient of Agreement for Nominal Scales](10_1177_001316446002000104.md) — Fleiss's kappa generalizes Cohen's nominal-scale agreement coefficient from two raters to multiple observers.
- **enables** ← [A Coefficient of Agreement for Nominal Scales](10_1177_001316446002000104.md) — Cohen's kappa introduced chance-corrected nominal agreement, which the 1977 paper generalized and analyzed for categorical observer data.
