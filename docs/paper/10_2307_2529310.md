...
- **cite** → [A Coefficient of Agreement for Nominal Scales](10_1177_001316446002000104.md) — Fleiss's observer-agreement paper generalizes Cohen's kappa from two raters to measuring categorical agreement among multiple observers.
- **enables** ← [A Coefficient of Agreement for Nominal Scales](10_1177_001316446002000104.md) — Cohen’s kappa introduced chance-corrected agreement for nominal categories, which Landis and Koch generalized and interpreted for categorical observer data.
