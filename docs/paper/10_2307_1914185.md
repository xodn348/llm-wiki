...
- **enables** → [Advances in prospect theory: Cumulative representation of uncertainty](10_1007_bf00122574.md) — Cumulative prospect theory extends original prospect theory by replacing decision weights with rank-dependent cumulative probability weighting.
- **cite** ← [Advances in prospect theory: Cumulative representation of uncertainty](10_1007_bf00122574.md) — Cumulative prospect theory revises the original prospect theory value function and probability-weighting account for risky choice.
- **cite** ← [The Framing of Decisions and the Psychology of Choice](10_1126_science_7455683.md) — The framing paper applies prospect theory's loss aversion and reference dependence to show that equivalent outcomes elicit different choices when framed as gains or losses.
