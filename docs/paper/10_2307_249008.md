...
- **cite** → [Self-efficacy mechanism in human agency.](10_1037_0003_066x_37_2_122.md) — Davis uses Bandura's self-efficacy theory to ground perceived ease of use as a belief about one's ability to use a system.
- **cite** → [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — Davis uses Campbell and Fiske's multitrait-multimethod matrix to validate perceived usefulness and perceived ease of use as distinct constructs.
- **cite** → [User Acceptance of Computer Technology: A Comparison of Two Theoretical Models](10_1287_mnsc_35_8_982.md) — Davis's technology acceptance model is directly compared with the theory of reasoned action model in Davis, Bagozzi, and Warshaw's user-acceptance study.
- **enables** ← [Self-efficacy mechanism in human agency.](10_1037_0003_066x_37_2_122.md) — Self-efficacy theory informs the perceived ease-of-use construct in the Technology Acceptance Model.
- **enables** ← [Convergent and discriminant validation by the multitrait-multimethod matrix.](10_1037_h0046016.md) — The multitrait-multimethod framework supplied the construct-validation logic used to test perceived usefulness and ease of use.
