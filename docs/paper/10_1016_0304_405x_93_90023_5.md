...
- **cite** → [CAPITAL ASSET PRICES: A THEORY OF MARKET EQUILIBRIUM UNDER CONDITIONS OF RISK*](10_1111_j_1540_6261_1964_tb02865_x.md) — Fama and French cite Sharpe's CAPM as the one-factor asset-pricing model their common risk factors extend.
- **cite** → [Risk, Return, and Equilibrium: Empirical Tests](10_1086_260061.md) — Fama and French cite Fama-MacBeth as the empirical testing methodology for estimating risk-return relations across assets.
- **cite** → [The Cross‐Section of Expected Stock Returns](10_1111_j_1540_6261_1992_tb04398_x.md) — Fama and French extend the 1992 size and book-to-market evidence into a three-factor asset-pricing model for stock and bond returns.
- **enables** ← [CAPITAL ASSET PRICES: A THEORY OF MARKET EQUILIBRIUM UNDER CONDITIONS OF RISK*](10_1111_j_1540_6261_1964_tb02865_x.md) — Sharpe's CAPM supplied the single-market-factor benchmark that Fama and French challenged with additional stock and bond return factors.
- **enables** ← [Risk, Return, and Equilibrium: Empirical Tests](10_1086_260061.md) — Fama-MacBeth cross-sectional regressions provided the empirical testing method behind Fama and French's evaluation of common return factors.
