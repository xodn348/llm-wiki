...
- **cite** → [Learning representations by back-propagating errors](10_1038_323533a0.md) — Support-vector networks contrast margin-based kernel learning with neural networks trained by back-propagation.
- **cite** → [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Support-vector networks cite Fisher's discriminant analysis as an earlier statistical approach to supervised classification from multiple measurements.
- **cite** → [A training algorithm for optimal margin classifiers](10_1145_130385_130401.md) — Support-vector networks develop the optimal-margin classifier framework introduced by Boser, Guyon, and Vapnik into a broader kernel-based method.
- **enables** ← [Learning representations by back-propagating errors](10_1038_323533a0.md) — Backpropagation popularized gradient-based learning of internal representations, providing a neural-network baseline and context for support-vector classification.
- **enables** ← [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Fisher's discriminant analysis framed classification as separating measured classes, a statistical precursor to support-vector decision boundaries.
