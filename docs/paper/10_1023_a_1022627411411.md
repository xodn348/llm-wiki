...
- **cite** → [Learning representations by back-propagating errors](10_1038_323533a0.md) — Support-Vector Networks contrasts margin-based kernel learning with neural-network representation learning trained by back-propagation.
- **cite** → [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Support-Vector Networks cites Fisher's taxonomic measurement work through the benchmark problem of classifying Iris data from multiple features.
- **cite** → [A training algorithm for optimal margin classifiers](10_1145_130385_130401.md) — Support-Vector Networks extends the optimal margin classifier algorithm into the support vector machine framework with kernels and soft margins.
- **enables** ← [Learning representations by back-propagating errors](10_1038_323533a0.md) — Back-propagation popularized supervised learning from labeled examples, which Support-Vector Networks reframed through maximum-margin optimization.
- **enables** ← [THE USE OF MULTIPLE MEASUREMENTS IN TAXONOMIC PROBLEMS](10_1111_j_1469_1809_1936_tb02137_x.md) — Fisher's linear discriminant introduced separating classes by measured features, a classification goal later generalized by support-vector hyperplanes.
