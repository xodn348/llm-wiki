...
- **cite** ← [Spatial reconstruction of single-cell gene expression data](10_1038_nbt_3192.md) — Spatial reconstruction cites pseudotemporal ordering as a single-cell analysis concept for inferring developmental progression from expression profiles.
