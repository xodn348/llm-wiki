...
- **cite** ← [Convolutional Neural Networks for Sentence Classification](10_3115_v1_d14_1181.md) — Kim compares CNN sentence classifiers against the Stanford Sentiment Treebank benchmark introduced with recursive neural tensor models for semantic compositionality.
