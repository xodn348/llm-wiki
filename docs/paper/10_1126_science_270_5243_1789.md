...
- **enables** → [Electron-Hole Diffusion Lengths Exceeding 1 Micrometer in an Organometal Trihalide Perovskite Absorber](10_1126_science_1243982.md) — Bulk heterojunction polymer photovoltaics framed donor-acceptor nanoscale charge separation, a benchmark for assessing whether perovskites need similar short diffusion paths.
- **enables** → [Single-Junction Organic Solar Cell with over 15% Efficiency Using Fused-Ring Acceptor with Electron-Deficient Core](10_1016_j_joule_2019_01_004.md) — Bulk donor-acceptor heterojunctions established the morphology principle that later fused-ring acceptor organic solar cells optimized for higher efficiency.
- **enables** → [Efficient Hybrid Solar Cells Based on Meso-Superstructured Organometal Halide Perovskites](10_1126_science_1228604.md) — Donor-acceptor heterojunction photovoltaic design enabled hybrid perovskite solar cells that separate light absorption and charge transport across interpenetrating phases.
- **cite** ← [Electron-Hole Diffusion Lengths Exceeding 1 Micrometer in an Organometal Trihalide Perovskite Absorber](10_1126_science_1243982.md) — The paper invokes bulk donor-acceptor heterojunction concepts as a comparison point for how long carrier diffusion can relax nanoscale intermixing requirements.
- **cite** ← [Single-Junction Organic Solar Cell with over 15% Efficiency Using Fused-Ring Acceptor with Electron-Deficient Core](10_1016_j_joule_2019_01_004.md) — The 15%-efficiency organic solar cell builds on the bulk donor-acceptor heterojunction concept introduced for polymer photovoltaic cells.
- **cite** ← [Efficient Hybrid Solar Cells Based on Meso-Superstructured Organometal Halide Perovskites](10_1126_science_1228604.md) — Lee et al. cite bulk donor-acceptor heterojunction photovoltaics as precedent for interpenetrating nanoscale charge-separation networks.
