...
- **enables** → [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — WordNet provided the synset hierarchy used to organize ImageNet categories and therefore the semantic label structure of ILSVRC.
- **cite** ← [ImageNet Large Scale Visual Recognition Challenge](10_1007_s11263_015_0816_y.md) — ILSVRC uses WordNet synsets as the semantic hierarchy for defining ImageNet object categories.
