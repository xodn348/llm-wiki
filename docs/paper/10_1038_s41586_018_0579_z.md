...
- **cite** → [UK Biobank: An Open Access Resource for Identifying the Causes of a Wide Range of Complex Diseases of Middle and Old Age](10_1371_journal_pmed_1001779.md) — The 2018 UK Biobank paper extends the 2015 UK Biobank resource description by adding deep phenotyping linked to genomic data.
- **cite** → [A global reference for human genetic variation](10_1038_nature15393.md) — The UK Biobank genomic resource cites the 1000 Genomes reference as a comparator and imputation reference for human genetic variation.
- **cite** → [A haplotype map of the human genome](10_1038_nature04226.md) — UK Biobank cites the HapMap project as a reference panel and precedent for using genome-wide haplotype structure to support large-scale human genetic association studies.
- **cite** → [Analysis of protein-coding genetic variation in 60,706 humans](10_1038_nature19057.md) — UK Biobank cites ExAC as evidence that very large sequencing cohorts enable population-scale interpretation of rare protein-coding genetic variation.
- **cite** ← [The GTEx Consortium atlas of genetic regulatory effects across human tissues](10_1126_science_aaz1776.md) — The 2020 GTEx atlas links tissue-specific regulatory variation to large-scale genotype-phenotype resources exemplified by UK Biobank.
- **enables** ← [A haplotype map of the human genome](10_1038_nature04226.md) — The HapMap catalog of common haplotypes enabled genotype imputation and population-scale genomic analysis in UK Biobank.
