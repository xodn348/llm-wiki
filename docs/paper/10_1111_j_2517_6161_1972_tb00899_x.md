...
- **cite** → [Nonparametric Estimation from Incomplete Observations](10_1080_01621459_1958_10501452.md) — Cox's proportional hazards model builds on Kaplan-Meier nonparametric survival estimation for censored life-table data.
- **enables** ← [Nonparametric Estimation from Incomplete Observations](10_1080_01621459_1958_10501452.md) — Cox regression builds on Kaplan-Meier survival analysis by modeling covariate effects while handling right-censored life-table data.
## Sources
