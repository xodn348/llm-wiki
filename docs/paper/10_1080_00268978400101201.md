...
- **cite** → [Polymorphic transitions in single crystals: A new molecular dynamics method](10_1063_1_328693.md) — Nosé's canonical-ensemble molecular dynamics builds on Parrinello-Rahman's variable-cell dynamics by extending MD with additional degrees of freedom for thermodynamic control.
- **cite** ← [Canonical dynamics: Equilibrium phase-space distributions](10_1103_physreva_31_1695.md) — Nosé's 1985 paper develops the canonical-ensemble molecular dynamics thermostat first proposed in his 1984 method.
