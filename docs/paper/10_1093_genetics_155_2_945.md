...
- **enables** → [PLINK: A Tool Set for Whole-Genome Association and Population-Based Linkage Analyses](10_1086_519795.md) — PLINK incorporates population-structure correction workflows motivated by STRUCTURE's multilocus inference of ancestry and admixture.
- **cite** ← [PLINK: A Tool Set for Whole-Genome Association and Population-Based Linkage Analyses](10_1086_519795.md) — PLINK uses population-structure inference from multilocus genotypes to control stratification in genome-wide association analyses.
## Sources
