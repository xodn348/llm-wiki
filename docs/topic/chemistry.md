...
- 1953 — [Molecular Structure of Nucleic Acids: A Structure for Deoxyribose Nucleic Acid](../paper/10_1038_171737a0.md)
...
- 2002 — [A Stepwise Huisgen Cycloaddition Process: Copper(I)-Catalyzed Regioselective “Ligation” of Azides and Terminal Alkynes](../paper/10_1002_1521_3773_20020715_41_14_2596__aid_anie2596_3_0_co_2_4.md)
- 2003 — [다양한 다공질 Calcium Polyphosphate의 생분해성에 관한 장기적인 연구](../paper/10_1056_nejmoa2001017.md)
- 2008 — [MaxQuant enables high peptide identification rates, individualized p.p.b.-range mass accuracies and proteome-wide protein quantification](../paper/10_1038_nbt_1511.md)
- 2009 — [Organometal Halide Perovskites as Visible-Light Sensitizers for Photovoltaic Cells](../paper/10_1021_ja809598r.md)
- 2011 — [Role of YAP/TAZ in mechanotransduction](../paper/10_1038_nature10137.md)
- 2011 — [Single-atom catalysis of CO oxidation using Pt1/FeOx](../paper/10_1038_nchem_1095.md)
- 2020 — [Cryo-EM structure of the 2019-nCoV spike in the prefusion conformation](../paper/10_1126_science_abb2507.md)
